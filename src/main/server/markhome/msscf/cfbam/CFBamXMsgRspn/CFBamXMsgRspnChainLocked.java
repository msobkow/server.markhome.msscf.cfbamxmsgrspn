...
/*
 *	CFBamXMsgRspnChainLocked XML SAX Element  implementation
 *	for Chain.
 */
public class CFBamXMsgRspnChainLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnChainLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnChainLocked" );
