...
/*
 *	CFBamXMsgRspnTopDomainRec XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFBamXMsgRspnTopDomainRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTopDomainRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFIntTopDomainObj> list =
				(List<ICFIntTopDomainObj>)xmsgRspn.getListOfObjects();
