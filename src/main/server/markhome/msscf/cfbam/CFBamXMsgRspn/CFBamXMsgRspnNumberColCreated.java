...
/*
 *	CFBamXMsgRspnNumberColCreated XML SAX Element  implementation
 *	for NumberCol.
 */
public class CFBamXMsgRspnNumberColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNumberColCreated" );
