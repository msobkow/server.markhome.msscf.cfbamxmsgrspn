...
/*
 *	CFBamXMsgRspnBlobTypeRec XML SAX Element  implementation
 *	for BlobType.
 */
public class CFBamXMsgRspnBlobTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
