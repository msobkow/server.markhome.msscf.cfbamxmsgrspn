...
/*
 *	CFBamXMsgRspnTZDateTypeCreated XML SAX Element  implementation
 *	for TZDateType.
 */
public class CFBamXMsgRspnTZDateTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZDateTypeCreated" );
