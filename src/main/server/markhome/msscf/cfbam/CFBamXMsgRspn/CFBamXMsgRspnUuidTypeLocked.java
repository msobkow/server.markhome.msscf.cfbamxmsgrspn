...
/*
 *	CFBamXMsgRspnUuidTypeLocked XML SAX Element  implementation
 *	for UuidType.
 */
public class CFBamXMsgRspnUuidTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidTypeLocked" );
