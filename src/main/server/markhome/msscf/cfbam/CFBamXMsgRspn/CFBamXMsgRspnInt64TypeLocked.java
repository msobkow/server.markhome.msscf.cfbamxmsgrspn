...
/*
 *	CFBamXMsgRspnInt64TypeLocked XML SAX Element  implementation
 *	for Int64Type.
 */
public class CFBamXMsgRspnInt64TypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt64TypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt64TypeLocked" );
