...
/*
 *	CFBamXMsgRspnUInt64TypeRec XML SAX Element  implementation
 *	for UInt64Type.
 */
public class CFBamXMsgRspnUInt64TypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64TypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
