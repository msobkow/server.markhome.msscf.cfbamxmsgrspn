...
/*
 *	CFBamXMsgRspnFloatDefLocked XML SAX Element  implementation
 *	for FloatDef.
 */
public class CFBamXMsgRspnFloatDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnFloatDefLocked" );
