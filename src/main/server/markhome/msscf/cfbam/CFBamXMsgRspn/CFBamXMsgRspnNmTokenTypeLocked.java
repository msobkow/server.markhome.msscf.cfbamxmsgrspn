...
/*
 *	CFBamXMsgRspnNmTokenTypeLocked XML SAX Element  implementation
 *	for NmTokenType.
 */
public class CFBamXMsgRspnNmTokenTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokenTypeLocked" );
