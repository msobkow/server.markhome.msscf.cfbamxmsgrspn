...
/*
 *	CFBamXMsgRspnTimestampDefCreated XML SAX Element  implementation
 *	for TimestampDef.
 */
public class CFBamXMsgRspnTimestampDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimestampDefCreated" );
