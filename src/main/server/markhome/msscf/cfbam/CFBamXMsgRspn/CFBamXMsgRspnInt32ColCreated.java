...
/*
 *	CFBamXMsgRspnInt32ColCreated XML SAX Element  implementation
 *	for Int32Col.
 */
public class CFBamXMsgRspnInt32ColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32ColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt32ColCreated" );
