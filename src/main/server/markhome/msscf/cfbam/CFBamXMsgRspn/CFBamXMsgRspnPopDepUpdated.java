...
// Description: Java 11 XML Message SAX Response Record Element  for PopDep
...
/*
 *	CFBamXMsgRspnPopDepUpdated XML SAX Element  implementation
 *	for PopDep.
 */
public class CFBamXMsgRspnPopDepUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopDepUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopDepUpdated" );
			...
			ICFBamPopDepObj obj = (ICFBamPopDepObj)schemaObj.getPopDepTableObj().newInstance();
			CFBamPopDepBuff dataBuff = obj.getPopDepBuff();
