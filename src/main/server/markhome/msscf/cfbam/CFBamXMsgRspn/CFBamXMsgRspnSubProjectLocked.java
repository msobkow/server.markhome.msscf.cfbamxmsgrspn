...
/*
 *	CFBamXMsgRspnSubProjectLocked XML SAX Element  implementation
 *	for SubProject.
 */
public class CFBamXMsgRspnSubProjectLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSubProjectLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSubProjectLocked" );
