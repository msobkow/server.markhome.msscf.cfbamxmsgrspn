...
/*
 *	CFBamXMsgRspnSchemaRefReadSingle XML SAX Element  implementation
 *	for SchemaRef.
 */
public class CFBamXMsgRspnSchemaRefReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSchemaRefReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSchemaRefReadSingle" );
