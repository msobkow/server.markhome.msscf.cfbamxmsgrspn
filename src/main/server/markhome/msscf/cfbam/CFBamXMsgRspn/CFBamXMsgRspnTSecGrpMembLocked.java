...
/*
 *	CFBamXMsgRspnTSecGrpMembLocked XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFBamXMsgRspnTSecGrpMembLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGrpMembLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGrpMembLocked" );
