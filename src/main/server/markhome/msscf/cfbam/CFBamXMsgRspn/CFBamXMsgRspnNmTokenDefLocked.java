...
/*
 *	CFBamXMsgRspnNmTokenDefLocked XML SAX Element  implementation
 *	for NmTokenDef.
 */
public class CFBamXMsgRspnNmTokenDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokenDefLocked" );
