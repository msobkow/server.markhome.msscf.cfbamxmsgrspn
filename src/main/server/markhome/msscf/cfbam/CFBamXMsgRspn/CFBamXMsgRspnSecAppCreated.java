...
/*
 *	CFBamXMsgRspnSecAppCreated XML SAX Element  implementation
 *	for SecApp.
 */
public class CFBamXMsgRspnSecAppCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecAppCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecAppCreated" );
