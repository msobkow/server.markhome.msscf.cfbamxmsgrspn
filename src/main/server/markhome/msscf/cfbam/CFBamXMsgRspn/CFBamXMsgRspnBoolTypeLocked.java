...
/*
 *	CFBamXMsgRspnBoolTypeLocked XML SAX Element  implementation
 *	for BoolType.
 */
public class CFBamXMsgRspnBoolTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBoolTypeLocked" );
