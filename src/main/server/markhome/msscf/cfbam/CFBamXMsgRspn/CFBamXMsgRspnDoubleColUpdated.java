...
/*
 *	CFBamXMsgRspnDoubleColUpdated XML SAX Element  implementation
 *	for DoubleCol.
 */
public class CFBamXMsgRspnDoubleColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDoubleColUpdated" );
