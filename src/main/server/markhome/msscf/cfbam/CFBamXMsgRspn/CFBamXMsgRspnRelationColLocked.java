...
/*
 *	CFBamXMsgRspnRelationColLocked XML SAX Element  implementation
 *	for RelationCol.
 */
public class CFBamXMsgRspnRelationColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnRelationColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnRelationColLocked" );
