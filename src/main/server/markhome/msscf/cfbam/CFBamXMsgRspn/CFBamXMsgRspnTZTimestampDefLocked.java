...
/*
 *	CFBamXMsgRspnTZTimestampDefLocked XML SAX Element  implementation
 *	for TZTimestampDef.
 */
public class CFBamXMsgRspnTZTimestampDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimestampDefLocked" );
