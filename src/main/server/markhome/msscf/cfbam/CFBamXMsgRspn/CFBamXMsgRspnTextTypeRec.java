...
// Description: Java 11 XML Message SAX Response Record Element  for TextType
...
/*
 *	CFBamXMsgRspnTextTypeRec XML SAX Element  implementation
 *	for TextType.
 */
public class CFBamXMsgRspnTextTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamTextTypeBuff dataBuff = obj.getTextTypeBuff();
