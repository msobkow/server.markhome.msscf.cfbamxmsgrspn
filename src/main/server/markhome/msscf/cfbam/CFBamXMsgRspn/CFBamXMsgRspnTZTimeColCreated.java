...
/*
 *	CFBamXMsgRspnTZTimeColCreated XML SAX Element  implementation
 *	for TZTimeCol.
 */
public class CFBamXMsgRspnTZTimeColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimeColCreated" );
