...
/*
 *	CFBamXMsgRspnTokenTypeLocked XML SAX Element  implementation
 *	for TokenType.
 */
public class CFBamXMsgRspnTokenTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTokenTypeLocked" );
