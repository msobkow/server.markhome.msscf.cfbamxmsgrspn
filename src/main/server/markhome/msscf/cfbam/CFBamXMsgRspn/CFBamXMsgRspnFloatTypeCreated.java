...
/*
 *	CFBamXMsgRspnFloatTypeCreated XML SAX Element  implementation
 *	for FloatType.
 */
public class CFBamXMsgRspnFloatTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnFloatTypeCreated" );
