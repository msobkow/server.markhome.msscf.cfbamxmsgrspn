...
// Description: Java 11 XML Message SAX Response Record Element  for Tld
...
/*
 *	CFBamXMsgRspnTldUpdated XML SAX Element  implementation
 *	for Tld.
 */
public class CFBamXMsgRspnTldUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTldUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTldUpdated" );
			...
			CFIntTldBuff dataBuff = obj.getTldBuff();
			...
			obj.copyBuffToPKey();
			ICFBamTldObj realised = (ICFBamTldObj)obj.realise();
