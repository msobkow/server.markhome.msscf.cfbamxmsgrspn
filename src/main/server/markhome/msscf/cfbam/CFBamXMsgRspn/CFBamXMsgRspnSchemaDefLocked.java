...
/*
 *	CFBamXMsgRspnSchemaDefLocked XML SAX Element  implementation
 *	for SchemaDef.
 */
public class CFBamXMsgRspnSchemaDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSchemaDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
