...
/*
 *	CFBamXMsgRspnTSecGroupLocked XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFBamXMsgRspnTSecGroupLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGroupLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
