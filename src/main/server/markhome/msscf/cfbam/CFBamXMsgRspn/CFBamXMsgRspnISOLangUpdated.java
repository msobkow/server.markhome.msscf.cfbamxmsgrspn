...
/*
 *	CFBamXMsgRspnISOLangUpdated XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFBamXMsgRspnISOLangUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOLangUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOLangUpdated" );
			...
			ICFBamISOLangObj obj = (ICFBamISOLangObj)schemaObj.getISOLangTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFBamISOLangObj realised = (ICFBamISOLangObj)obj.realise();
