...
/*
 *	CFBamXMsgRspnUInt64ColCreated XML SAX Element  implementation
 *	for UInt64Col.
 */
public class CFBamXMsgRspnUInt64ColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64ColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt64ColCreated" );
