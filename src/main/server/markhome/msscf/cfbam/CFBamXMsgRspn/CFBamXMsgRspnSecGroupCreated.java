...
/*
 *	CFBamXMsgRspnSecGroupCreated XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFBamXMsgRspnSecGroupCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGroupCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecGroupCreated" );
			...
			ICFBamSecGroupObj obj = (ICFBamSecGroupObj)schemaObj.getSecGroupTableObj().newInstance();
			CFSecSecGroupBuff dataBuff = obj.getSecGroupBuff();
			...
			obj.copyBuffToPKey();
			ICFBamSecGroupObj realised = (ICFBamSecGroupObj)obj.realise();
