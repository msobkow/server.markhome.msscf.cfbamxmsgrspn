...
/*
 *	CFBamXMsgRspnStringTypeUpdated XML SAX Element  implementation
 *	for StringType.
 */
public class CFBamXMsgRspnStringTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnStringTypeUpdated" );
