...
/*
 *	CFBamXMsgRspnTimestampColUpdated XML SAX Element  implementation
 *	for TimestampCol.
 */
public class CFBamXMsgRspnTimestampColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimestampColUpdated" );
