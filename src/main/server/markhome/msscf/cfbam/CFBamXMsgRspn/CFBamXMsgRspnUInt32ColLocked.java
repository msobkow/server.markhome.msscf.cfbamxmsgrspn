...
/*
 *	CFBamXMsgRspnUInt32ColLocked XML SAX Element  implementation
 *	for UInt32Col.
 */
public class CFBamXMsgRspnUInt32ColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32ColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt32ColLocked" );
