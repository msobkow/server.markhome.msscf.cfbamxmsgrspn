...
/*
 *	CFBamXMsgRspnFloatColUpdated XML SAX Element  implementation
 *	for FloatCol.
 */
public class CFBamXMsgRspnFloatColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnFloatColUpdated" );
