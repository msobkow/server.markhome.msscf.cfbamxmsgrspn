...
/*
 *	CFBamXMsgRspnBlobTypeReadSingle XML SAX Element  implementation
 *	for BlobType.
 */
public class CFBamXMsgRspnBlobTypeReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobTypeReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobTypeReadSingle" );
