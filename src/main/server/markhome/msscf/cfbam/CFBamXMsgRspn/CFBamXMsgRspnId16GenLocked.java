...
/*
 *	CFBamXMsgRspnId16GenLocked XML SAX Element  implementation
 *	for Id16Gen.
 */
public class CFBamXMsgRspnId16GenLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnId16GenLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnId16GenLocked" );
