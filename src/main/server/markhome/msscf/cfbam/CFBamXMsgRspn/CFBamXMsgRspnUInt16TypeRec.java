...
// Description: Java 11 XML Message SAX Response Record Element  for UInt16Type
...
/*
 *	CFBamXMsgRspnUInt16TypeRec XML SAX Element  implementation
 *	for UInt16Type.
 */
public class CFBamXMsgRspnUInt16TypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16TypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "UInt16Type" );
			...
			CFBamUInt16TypeBuff dataBuff = obj.getUInt16TypeBuff();
