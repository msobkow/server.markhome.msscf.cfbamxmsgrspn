...
/*
 *	CFBamXMsgRspnStringTypeLocked XML SAX Element  implementation
 *	for StringType.
 */
public class CFBamXMsgRspnStringTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnStringTypeLocked" );
