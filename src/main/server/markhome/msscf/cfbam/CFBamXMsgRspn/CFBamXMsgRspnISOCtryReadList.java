...
/*
 *	CFBamXMsgRspnISOCtryReadList XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFBamXMsgRspnISOCtryReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCtryReadList" );
			...
			List<ICFSecISOCtryObj> sortedList =
				new ArrayList<ICFSecISOCtryObj>();
