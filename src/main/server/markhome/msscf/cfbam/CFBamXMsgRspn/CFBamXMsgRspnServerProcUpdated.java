...
/*
 *	CFBamXMsgRspnServerProcUpdated XML SAX Element  implementation
 *	for ServerProc.
 */
public class CFBamXMsgRspnServerProcUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerProcUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerProcUpdated" );
