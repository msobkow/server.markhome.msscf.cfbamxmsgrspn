...
/*
 *	CFBamXMsgRspnUInt16ColUpdated XML SAX Element  implementation
 *	for UInt16Col.
 */
public class CFBamXMsgRspnUInt16ColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16ColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt16ColUpdated" );
