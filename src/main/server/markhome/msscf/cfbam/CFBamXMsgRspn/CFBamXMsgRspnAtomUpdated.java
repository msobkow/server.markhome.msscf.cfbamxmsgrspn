...
/*
 *	CFBamXMsgRspnAtomUpdated XML SAX Element  implementation
 *	for Atom.
 */
public class CFBamXMsgRspnAtomUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnAtomUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnAtomUpdated" );
