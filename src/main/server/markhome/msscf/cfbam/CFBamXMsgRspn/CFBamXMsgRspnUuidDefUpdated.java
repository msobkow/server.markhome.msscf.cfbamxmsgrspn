...
/*
 *	CFBamXMsgRspnUuidDefUpdated XML SAX Element  implementation
 *	for UuidDef.
 */
public class CFBamXMsgRspnUuidDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidDefUpdated" );
