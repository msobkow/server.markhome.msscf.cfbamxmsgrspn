...
/*
 *	CFBamXMsgRspnSecDeviceReadSingle XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFBamXMsgRspnSecDeviceReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecDeviceReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecDeviceReadSingle" );
