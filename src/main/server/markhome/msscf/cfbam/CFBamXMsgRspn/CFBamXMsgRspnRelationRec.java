...
// Description: Java 11 XML Message SAX Response Record Element  for Relation
...
/*
 *	CFBamXMsgRspnRelationRec XML SAX Element  implementation
 *	for Relation.
 */
public class CFBamXMsgRspnRelationRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnRelationRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			if( ( attrNarrowedTenantId == null ) || ( attrNarrowedTenantId.length() <= 0 ) ) {
				...
				natNarrowedTenantId = Long.valueOf( Long.parseLong( attrNarrowedTenantId ) );
			}
			...
			if( ( attrNarrowedId == null ) || ( attrNarrowedId.length() <= 0 ) ) {
				...
				natNarrowedId = Long.valueOf( Long.parseLong( attrNarrowedId ) );
			}
			...
			dataBuff.setRequiredRelationType( natRelationType );
			...
			dataBuff.setRequiredIsLateResolver( natIsLateResolver );
			dataBuff.setRequiredAllowAddendum( natAllowAddendum );
