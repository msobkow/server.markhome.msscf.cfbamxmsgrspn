...
/*
 *	CFBamXMsgRspnId64GenUpdated XML SAX Element  implementation
 *	for Id64Gen.
 */
public class CFBamXMsgRspnId64GenUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnId64GenUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnId64GenUpdated" );
