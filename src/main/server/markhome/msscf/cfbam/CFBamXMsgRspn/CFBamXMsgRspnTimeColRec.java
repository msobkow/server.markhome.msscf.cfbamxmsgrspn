...
// Description: Java 11 XML Message SAX Response Record Element  for TimeCol
...
/*
 *	CFBamXMsgRspnTimeColRec XML SAX Element  implementation
 *	for TimeCol.
 */
public class CFBamXMsgRspnTimeColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamTimeColBuff dataBuff = obj.getTimeColBuff();
