...
/*
 *	CFBamXMsgRspnEnumTypeUpdated XML SAX Element  implementation
 *	for EnumType.
 */
public class CFBamXMsgRspnEnumTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnEnumTypeUpdated" );
