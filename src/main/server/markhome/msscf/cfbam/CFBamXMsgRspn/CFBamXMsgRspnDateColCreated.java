...
/*
 *	CFBamXMsgRspnDateColCreated XML SAX Element  implementation
 *	for DateCol.
 */
public class CFBamXMsgRspnDateColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDateColCreated" );
