...
/*
 *	CFBamXMsgRspnNumberColLocked XML SAX Element  implementation
 *	for NumberCol.
 */
public class CFBamXMsgRspnNumberColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNumberColLocked" );
