...
/*
 *	CFBamXMsgRspnPopSubDep2Locked XML SAX Element  implementation
 *	for PopSubDep2.
 */
public class CFBamXMsgRspnPopSubDep2Locked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep2Locked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopSubDep2Locked" );
