...
/*
 *	CFBamXMsgRspnTldRec XML SAX Element  implementation
 *	for Tld.
 */
public class CFBamXMsgRspnTldRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTldRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFIntTldObj> list =
				(List<ICFIntTldObj>)xmsgRspn.getListOfObjects();
