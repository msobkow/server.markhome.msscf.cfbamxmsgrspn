...
/*
 *	CFBamXMsgRspnNmTokensDefCreated XML SAX Element  implementation
 *	for NmTokensDef.
 */
public class CFBamXMsgRspnNmTokensDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokensDefCreated" );
