...
/*
 *	CFBamXMsgRspnDateDefUpdated XML SAX Element  implementation
 *	for DateDef.
 */
public class CFBamXMsgRspnDateDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDateDefUpdated" );
