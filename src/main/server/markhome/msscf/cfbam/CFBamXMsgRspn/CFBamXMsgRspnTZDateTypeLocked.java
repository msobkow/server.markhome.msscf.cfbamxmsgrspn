...
/*
 *	CFBamXMsgRspnTZDateTypeLocked XML SAX Element  implementation
 *	for TZDateType.
 */
public class CFBamXMsgRspnTZDateTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZDateTypeLocked" );
