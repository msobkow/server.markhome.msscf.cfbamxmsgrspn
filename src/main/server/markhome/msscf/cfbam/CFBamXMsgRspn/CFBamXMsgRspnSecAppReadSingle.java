...
/*
 *	CFBamXMsgRspnSecAppReadSingle XML SAX Element  implementation
 *	for SecApp.
 */
public class CFBamXMsgRspnSecAppReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecAppReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecAppReadSingle" );
