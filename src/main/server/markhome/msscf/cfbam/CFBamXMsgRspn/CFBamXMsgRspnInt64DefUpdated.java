...
// Description: Java 11 XML Message SAX Response Record Element  for Int64Def
...
/*
 *	CFBamXMsgRspnInt64DefUpdated XML SAX Element  implementation
 *	for Int64Def.
 */
public class CFBamXMsgRspnInt64DefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt64DefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt64DefUpdated" );
			...
			ICFBamInt64DefObj obj = (ICFBamInt64DefObj)schemaObj.getInt64DefTableObj().newInstance();
			CFBamInt64DefBuff dataBuff = obj.getInt64DefBuff();
