...
/*
 *	CFBamXMsgRspnSchemaRefLocked XML SAX Element  implementation
 *	for SchemaRef.
 */
public class CFBamXMsgRspnSchemaRefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSchemaRefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSchemaRefLocked" );
