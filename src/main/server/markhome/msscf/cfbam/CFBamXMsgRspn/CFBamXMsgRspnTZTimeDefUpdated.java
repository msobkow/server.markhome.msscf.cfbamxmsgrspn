...
/*
 *	CFBamXMsgRspnTZTimeDefUpdated XML SAX Element  implementation
 *	for TZTimeDef.
 */
public class CFBamXMsgRspnTZTimeDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimeDefUpdated" );
