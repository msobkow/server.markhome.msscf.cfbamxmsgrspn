...
// Description: Java 11 XML Message SAX Response Record Element  for DelSubDep2
...
/*
 *	CFBamXMsgRspnDelSubDep2Rec XML SAX Element  implementation
 *	for DelSubDep2.
 */
public class CFBamXMsgRspnDelSubDep2Rec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep2Rec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			String	attrDelSubDep1TenantId = null;
			String	attrDelSubDep1Id = null;
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "DelSubDep1TenantId" ) ) {
					if( attrDelSubDep1TenantId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrDelSubDep1TenantId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "DelSubDep1Id" ) ) {
					if( attrDelSubDep1Id != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrDelSubDep1Id = attrs.getValue( idxAttr );
				}
			...
			if( ( attrDelSubDep1TenantId == null ) || ( attrDelSubDep1TenantId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"DelSubDep1TenantId" );
			}
			if( ( attrDelSubDep1Id == null ) || ( attrDelSubDep1Id.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"DelSubDep1Id" );
			...
			long natDelSubDep1TenantId = Long.parseLong( attrDelSubDep1TenantId );

			long natDelSubDep1Id = Long.parseLong( attrDelSubDep1Id );
			...
			CFBamDelSubDep2Buff dataBuff = obj.getDelSubDep2Buff();
			...
			dataBuff.setRequiredDelSubDep1TenantId( natDelSubDep1TenantId );
			dataBuff.setRequiredDelSubDep1Id( natDelSubDep1Id );
