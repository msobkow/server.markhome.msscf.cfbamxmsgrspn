...
// Description: Java 11 XML Message SAX Response Record Element  for TZTimeDef
...
/*
 *	CFBamXMsgRspnTZTimeDefRec XML SAX Element  implementation
 *	for TZTimeDef.
 */
public class CFBamXMsgRspnTZTimeDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimeDefObj obj = (ICFBamTZTimeDefObj)(schemaObj.getTZTimeDefTableObj().newInstance());
			CFBamTZTimeDefBuff dataBuff = obj.getTZTimeDefBuff();
