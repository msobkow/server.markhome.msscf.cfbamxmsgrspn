...
/*
 *	CFBamXMsgRspnTimeTypeUpdated XML SAX Element  implementation
 *	for TimeType.
 */
public class CFBamXMsgRspnTimeTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimeTypeUpdated" );
