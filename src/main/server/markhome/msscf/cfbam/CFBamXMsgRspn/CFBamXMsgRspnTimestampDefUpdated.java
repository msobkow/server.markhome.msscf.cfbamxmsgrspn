...
/*
 *	CFBamXMsgRspnTimestampDefUpdated XML SAX Element  implementation
 *	for TimestampDef.
 */
public class CFBamXMsgRspnTimestampDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimestampDefUpdated" );
