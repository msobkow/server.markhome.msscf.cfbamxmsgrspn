...
/*
 *	CFBamXMsgRspnValueUpdated XML SAX Element  implementation
 *	for Value.
 */
public class CFBamXMsgRspnValueUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnValueUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnValueUpdated" );
