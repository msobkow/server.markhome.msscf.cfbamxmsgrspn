...
/*
 *	CFBamXMsgRspnTimeTypeCreated XML SAX Element  implementation
 *	for TimeType.
 */
public class CFBamXMsgRspnTimeTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimeTypeCreated" );
