...
/*
 *	CFBamXMsgRspnBoolTypeCreated XML SAX Element  implementation
 *	for BoolType.
 */
public class CFBamXMsgRspnBoolTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBoolTypeCreated" );
