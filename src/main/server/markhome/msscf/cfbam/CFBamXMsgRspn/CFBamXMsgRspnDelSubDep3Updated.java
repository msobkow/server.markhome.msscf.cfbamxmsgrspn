...
/*
 *	CFBamXMsgRspnDelSubDep3Updated XML SAX Element  implementation
 *	for DelSubDep3.
 */
public class CFBamXMsgRspnDelSubDep3Updated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep3Updated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelSubDep3Updated" );
