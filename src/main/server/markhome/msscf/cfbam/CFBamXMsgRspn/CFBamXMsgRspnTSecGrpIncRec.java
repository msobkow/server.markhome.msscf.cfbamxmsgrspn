...
/*
 *	CFBamXMsgRspnTSecGrpIncRec XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFBamXMsgRspnTSecGrpIncRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGrpIncRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecTSecGrpIncObj> list =
				(List<ICFSecTSecGrpIncObj>)xmsgRspn.getListOfObjects();
