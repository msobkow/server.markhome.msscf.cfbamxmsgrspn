...
/*
 *	CFBamXMsgRspnStringTypeCreated XML SAX Element  implementation
 *	for StringType.
 */
public class CFBamXMsgRspnStringTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnStringTypeCreated" );
