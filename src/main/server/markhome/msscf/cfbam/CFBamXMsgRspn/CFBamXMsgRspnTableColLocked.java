...
/*
 *	CFBamXMsgRspnTableColLocked XML SAX Element  implementation
 *	for TableCol.
 */
public class CFBamXMsgRspnTableColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTableColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTableColLocked" );
