...
/*
 *	CFBamXMsgRspnTSecGroupCreated XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFBamXMsgRspnTSecGroupCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGroupCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGroupCreated" );
