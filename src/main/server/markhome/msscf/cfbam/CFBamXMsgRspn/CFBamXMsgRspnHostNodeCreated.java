...
/*
 *	CFBamXMsgRspnHostNodeCreated XML SAX Element  implementation
 *	for HostNode.
 */
public class CFBamXMsgRspnHostNodeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnHostNodeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
