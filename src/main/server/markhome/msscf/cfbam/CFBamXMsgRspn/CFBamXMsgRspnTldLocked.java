...
/*
 *	CFBamXMsgRspnTldLocked XML SAX Element  implementation
 *	for Tld.
 */
public class CFBamXMsgRspnTldLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTldLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTldLocked" );
