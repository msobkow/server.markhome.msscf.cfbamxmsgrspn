...
/*
 *	CFBamXMsgRspnLoggedOut XML SAX Element  implementation
 */
public class CFBamXMsgRspnLoggedOut
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnLoggedOut( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnLoggedOut" );
