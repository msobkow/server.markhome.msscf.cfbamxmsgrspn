...
// Description: Java 11 XML Message SAX Response Record Element  for TokenDef
...
/*
 *	CFBamXMsgRspnTokenDefRec XML SAX Element  implementation
 *	for TokenDef.
 */
public class CFBamXMsgRspnTokenDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTokenDefObj obj = (ICFBamTokenDefObj)(schemaObj.getTokenDefTableObj().newInstance());
			CFBamTokenDefBuff dataBuff = obj.getTokenDefBuff();
