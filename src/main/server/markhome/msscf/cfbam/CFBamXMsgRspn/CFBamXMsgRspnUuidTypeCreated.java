...
/*
 *	CFBamXMsgRspnUuidTypeCreated XML SAX Element  implementation
 *	for UuidType.
 */
public class CFBamXMsgRspnUuidTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidTypeCreated" );
