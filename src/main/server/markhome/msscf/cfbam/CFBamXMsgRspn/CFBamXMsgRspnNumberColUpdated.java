...
/*
 *	CFBamXMsgRspnNumberColUpdated XML SAX Element  implementation
 *	for NumberCol.
 */
public class CFBamXMsgRspnNumberColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNumberColUpdated" );
