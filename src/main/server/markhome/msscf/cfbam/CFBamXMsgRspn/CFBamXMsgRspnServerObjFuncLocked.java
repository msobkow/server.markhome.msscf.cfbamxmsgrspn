...
/*
 *	CFBamXMsgRspnServerObjFuncLocked XML SAX Element  implementation
 *	for ServerObjFunc.
 */
public class CFBamXMsgRspnServerObjFuncLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerObjFuncLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerObjFuncLocked" );
