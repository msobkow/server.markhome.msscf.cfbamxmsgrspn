...
/*
 *	CFBamXMsgRspnTSecGroupReadList XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFBamXMsgRspnTSecGroupReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGroupReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGroupReadList" );
			...
			List<ICFSecTSecGroupObj> sortedList =
				new ArrayList<ICFSecTSecGroupObj>();
