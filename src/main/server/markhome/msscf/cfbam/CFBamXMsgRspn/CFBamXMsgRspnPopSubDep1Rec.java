...
/*
 *	CFBamXMsgRspnPopSubDep1Rec XML SAX Element  implementation
 *	for PopSubDep1.
 */
public class CFBamXMsgRspnPopSubDep1Rec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep1Rec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "PopSubDep1" );
