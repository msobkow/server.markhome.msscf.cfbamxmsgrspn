...
/*
 *	CFBamXMsgRspnSecGrpMembRec XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFBamXMsgRspnSecGrpMembRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGrpMembRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecSecGrpMembObj> list =
				(List<ICFSecSecGrpMembObj>)xmsgRspn.getListOfObjects();
