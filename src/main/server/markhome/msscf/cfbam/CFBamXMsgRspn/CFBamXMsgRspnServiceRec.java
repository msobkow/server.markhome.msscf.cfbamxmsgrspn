...
/*
 *	CFBamXMsgRspnServiceRec XML SAX Element  implementation
 *	for Service.
 */
public class CFBamXMsgRspnServiceRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServiceRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecServiceObj> list =
				(List<ICFSecServiceObj>)xmsgRspn.getListOfObjects();
