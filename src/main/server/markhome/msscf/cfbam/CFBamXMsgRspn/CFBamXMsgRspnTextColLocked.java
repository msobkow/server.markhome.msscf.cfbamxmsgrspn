...
/*
 *	CFBamXMsgRspnTextColLocked XML SAX Element  implementation
 *	for TextCol.
 */
public class CFBamXMsgRspnTextColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTextColLocked" );
