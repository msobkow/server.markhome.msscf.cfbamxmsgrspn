...
/*
 *	CFBamXMsgRspnRelationColCreated XML SAX Element  implementation
 *	for RelationCol.
 */
public class CFBamXMsgRspnRelationColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnRelationColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnRelationColCreated" );
