...
/*
 *	CFBamXMsgRspnInt16DefLocked XML SAX Element  implementation
 *	for Int16Def.
 */
public class CFBamXMsgRspnInt16DefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16DefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt16DefLocked" );
