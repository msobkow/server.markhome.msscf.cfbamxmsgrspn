...
/*
 *	CFBamXMsgRspnBlobDefUpdated XML SAX Element  implementation
 *	for BlobDef.
 */
public class CFBamXMsgRspnBlobDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobDefUpdated" );
