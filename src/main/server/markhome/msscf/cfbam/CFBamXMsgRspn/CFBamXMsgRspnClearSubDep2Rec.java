...
// Description: Java 11 XML Message SAX Response Record Element  for ClearSubDep2
...
/*
 *	CFBamXMsgRspnClearSubDep2Rec XML SAX Element  implementation
 *	for ClearSubDep2.
 */
public class CFBamXMsgRspnClearSubDep2Rec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep2Rec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			// ClearSubDep2 Attributes
			String	attrClearSubDep1TenantId = null;
			String	attrClearSubDep1Id = null;
			...
			assert qName.equals( "ClearSubDep2" );
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "ClearSubDep1TenantId" ) ) {
					if( attrClearSubDep1TenantId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrClearSubDep1TenantId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "ClearSubDep1Id" ) ) {
					if( attrClearSubDep1Id != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrClearSubDep1Id = attrs.getValue( idxAttr );
				}
			...
			if( ( attrClearSubDep1TenantId == null ) || ( attrClearSubDep1TenantId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"ClearSubDep1TenantId" );
			}
			if( ( attrClearSubDep1Id == null ) || ( attrClearSubDep1Id.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"ClearSubDep1Id" );
			...
			long natClearSubDep1TenantId = Long.parseLong( attrClearSubDep1TenantId );

			long natClearSubDep1Id = Long.parseLong( attrClearSubDep1Id );
			...
			CFBamClearSubDep2Buff dataBuff = obj.getClearSubDep2Buff();
			...
			dataBuff.setRequiredClearSubDep1TenantId( natClearSubDep1TenantId );
			dataBuff.setRequiredClearSubDep1Id( natClearSubDep1Id );
			dataBuff.setRequiredName( natName );
			obj.copyBuffToPKey();
			@SuppressWarnings("unchecked")
			List<ICFBamScopeObj> list =
				(List<ICFBamScopeObj>)xmsgRspn.getListOfObjects();
