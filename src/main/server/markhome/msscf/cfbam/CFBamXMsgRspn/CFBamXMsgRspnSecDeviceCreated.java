...
/*
 *	CFBamXMsgRspnSecDeviceCreated XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFBamXMsgRspnSecDeviceCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecDeviceCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
