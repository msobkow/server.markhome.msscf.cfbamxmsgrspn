...
/*
 *	CFBamXMsgRspnTSecGroupReadSingle XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFBamXMsgRspnTSecGroupReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGroupReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGroupReadSingle" );
