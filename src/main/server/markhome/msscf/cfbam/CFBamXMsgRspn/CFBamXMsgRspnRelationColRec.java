...
// Description: Java 11 XML Message SAX Response Record Element  for RelationCol
...
/*
 *	CFBamXMsgRspnRelationColRec XML SAX Element  implementation
 *	for RelationCol.
 */
public class CFBamXMsgRspnRelationColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnRelationColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamRelationColBuff dataBuff = obj.getRelationColBuff();
			...
			List<ICFBamRelationColObj> list =
				(List<ICFBamRelationColObj>)xmsgRspn.getListOfObjects();
