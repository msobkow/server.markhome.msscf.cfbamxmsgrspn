...
/*
 *	CFBamXMsgRspnHostNodeDeleted XML SAX Element  implementation
 *	for HostNode.
 */
public class CFBamXMsgRspnHostNodeDeleted
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnHostNodeDeleted( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
