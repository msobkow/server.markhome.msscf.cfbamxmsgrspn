...
/*
 *	CFBamXMsgRspnServiceTypeRec XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFBamXMsgRspnServiceTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServiceTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecServiceTypeObj> list =
				(List<ICFSecServiceTypeObj>)xmsgRspn.getListOfObjects();
