...
// Description: Java 11 XML Message SAX Response Record Element  for TextDef
...
/*
 *	CFBamXMsgRspnTextDefRec XML SAX Element  implementation
 *	for TextDef.
 */
public class CFBamXMsgRspnTextDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTextDefObj obj = (ICFBamTextDefObj)(schemaObj.getTextDefTableObj().newInstance());
			CFBamTextDefBuff dataBuff = obj.getTextDefBuff();
			...
			ICFBamTextDefObj realised = (ICFBamTextDefObj)obj.realise();
