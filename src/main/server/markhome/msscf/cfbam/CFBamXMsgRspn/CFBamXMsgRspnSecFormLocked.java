...
/*
 *	CFBamXMsgRspnSecFormLocked XML SAX Element  implementation
 *	for SecForm.
 */
public class CFBamXMsgRspnSecFormLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecFormLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
