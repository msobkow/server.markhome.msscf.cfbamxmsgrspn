...
/*
 *	CFBamXMsgRspnDelTopDepLocked XML SAX Element  implementation
 *	for DelTopDep.
 */
public class CFBamXMsgRspnDelTopDepLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelTopDepLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelTopDepLocked" );
