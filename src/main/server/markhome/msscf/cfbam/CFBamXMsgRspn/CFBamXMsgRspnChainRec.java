...
// Description: Java 11 XML Message SAX Response Record Element  for Chain
...
/*
 *	CFBamXMsgRspnChainRec XML SAX Element  implementation
 *	for Chain.
 */
public class CFBamXMsgRspnChainRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnChainRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			String	attrPrevRelationTenantId = null;
			String	attrPrevRelationId = null;
			String	attrNextRelationTenantId = null;
			String	attrNextRelationId = null;
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "PrevRelationTenantId" ) ) {
					if( attrPrevRelationTenantId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrPrevRelationTenantId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "PrevRelationId" ) ) {
					if( attrPrevRelationId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrPrevRelationId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "NextRelationTenantId" ) ) {
					if( attrNextRelationTenantId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrNextRelationTenantId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "NextRelationId" ) ) {
					if( attrNextRelationId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrNextRelationId = attrs.getValue( idxAttr );
				}
			...
			if( ( attrPrevRelationTenantId == null ) || ( attrPrevRelationTenantId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"PrevRelationTenantId" );
			}
			if( ( attrPrevRelationId == null ) || ( attrPrevRelationId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"PrevRelationId" );
			}
			if( ( attrNextRelationTenantId == null ) || ( attrNextRelationTenantId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"NextRelationTenantId" );
			}
			if( ( attrNextRelationId == null ) || ( attrNextRelationId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"NextRelationId" );
			...
			long natPrevRelationTenantId = Long.parseLong( attrPrevRelationTenantId );

			long natPrevRelationId = Long.parseLong( attrPrevRelationId );

			long natNextRelationTenantId = Long.parseLong( attrNextRelationTenantId );

			long natNextRelationId = Long.parseLong( attrNextRelationId );
			...
			CFBamChainBuff dataBuff = obj.getChainBuff();
			...
			dataBuff.setRequiredPrevRelationTenantId( natPrevRelationTenantId );
			dataBuff.setRequiredPrevRelationId( natPrevRelationId );
			dataBuff.setRequiredNextRelationTenantId( natNextRelationTenantId );
			dataBuff.setRequiredNextRelationId( natNextRelationId );
			...
			List<ICFBamChainObj> list =
				(List<ICFBamChainObj>)xmsgRspn.getListOfObjects();
