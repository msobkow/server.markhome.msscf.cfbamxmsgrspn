...
/*
 *	CFBamXMsgRspnPopSubDep1Updated XML SAX Element  implementation
 *	for PopSubDep1.
 */
public class CFBamXMsgRspnPopSubDep1Updated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep1Updated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopSubDep1Updated" );
