...
/*
 *	CFBamXMsgRspnNmTokenDefUpdated XML SAX Element  implementation
 *	for NmTokenDef.
 */
public class CFBamXMsgRspnNmTokenDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokenDefUpdated" );
