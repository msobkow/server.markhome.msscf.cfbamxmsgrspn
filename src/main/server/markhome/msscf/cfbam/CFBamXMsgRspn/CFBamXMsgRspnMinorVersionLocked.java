...
/*
 *	CFBamXMsgRspnMinorVersionLocked XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFBamXMsgRspnMinorVersionLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnMinorVersionLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnMinorVersionLocked" );
