...
/*
 *	CFBamXMsgRspnInt64DefLocked XML SAX Element  implementation
 *	for Int64Def.
 */
public class CFBamXMsgRspnInt64DefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt64DefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt64DefLocked" );
