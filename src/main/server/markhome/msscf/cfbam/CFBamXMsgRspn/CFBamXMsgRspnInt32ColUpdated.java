...
// Description: Java 11 XML Message SAX Response Record Element  for Int32Col
...
/*
 *	CFBamXMsgRspnInt32ColUpdated XML SAX Element  implementation
 *	for Int32Col.
 */
public class CFBamXMsgRspnInt32ColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32ColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt32ColUpdated" );
			...
			CFBamInt32ColBuff dataBuff = obj.getInt32ColBuff();
