...
/*
 *	CFBamXMsgRspnClearTopDepLocked XML SAX Element  implementation
 *	for ClearTopDep.
 */
public class CFBamXMsgRspnClearTopDepLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearTopDepLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearTopDepLocked" );
