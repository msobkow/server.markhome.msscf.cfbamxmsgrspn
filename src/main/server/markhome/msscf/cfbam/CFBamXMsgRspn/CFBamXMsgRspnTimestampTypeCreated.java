...
// Description: Java 11 XML Message SAX Response Record Element  for TimestampType
...
/*
 *	CFBamXMsgRspnTimestampTypeCreated XML SAX Element  implementation
 *	for TimestampType.
 */
public class CFBamXMsgRspnTimestampTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimestampTypeCreated" );
