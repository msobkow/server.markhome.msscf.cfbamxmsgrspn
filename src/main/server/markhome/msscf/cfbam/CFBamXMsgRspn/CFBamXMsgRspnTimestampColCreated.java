...
/*
 *	CFBamXMsgRspnTimestampColCreated XML SAX Element  implementation
 *	for TimestampCol.
 */
public class CFBamXMsgRspnTimestampColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimestampColCreated" );
