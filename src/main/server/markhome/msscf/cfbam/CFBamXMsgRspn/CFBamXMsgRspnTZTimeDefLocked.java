...
/*
 *	CFBamXMsgRspnTZTimeDefLocked XML SAX Element  implementation
 *	for TZTimeDef.
 */
public class CFBamXMsgRspnTZTimeDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimeDefLocked" );
