...
/*
 *	CFBamXMsgRspnURLProtocolUpdated XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFBamXMsgRspnURLProtocolUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnURLProtocolUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnURLProtocolUpdated" );
			...
			ICFBamURLProtocolObj obj = (ICFBamURLProtocolObj)schemaObj.getURLProtocolTableObj().newInstance();
			CFIntURLProtocolBuff dataBuff = obj.getURLProtocolBuff();
			...
			obj.copyBuffToPKey();
			ICFBamURLProtocolObj realised = (ICFBamURLProtocolObj)obj.realise();
