...
/*
 *	CFBamXMsgRspnDelSubDep1Updated XML SAX Element  implementation
 *	for DelSubDep1.
 */
public class CFBamXMsgRspnDelSubDep1Updated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep1Updated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelSubDep1Updated" );
