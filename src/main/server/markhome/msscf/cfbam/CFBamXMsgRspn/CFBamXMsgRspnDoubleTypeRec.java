...
// Description: Java 11 XML Message SAX Response Record Element  for DoubleType
...
/*
 *	CFBamXMsgRspnDoubleTypeRec XML SAX Element  implementation
 *	for DoubleType.
 */
public class CFBamXMsgRspnDoubleTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "DoubleType" );
			...
			CFBamDoubleTypeBuff dataBuff = obj.getDoubleTypeBuff();
