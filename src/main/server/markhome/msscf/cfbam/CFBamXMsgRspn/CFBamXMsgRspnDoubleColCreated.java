...
/*
 *	CFBamXMsgRspnDoubleColCreated XML SAX Element  implementation
 *	for DoubleCol.
 */
public class CFBamXMsgRspnDoubleColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDoubleColCreated" );
