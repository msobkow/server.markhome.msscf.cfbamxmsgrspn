...
/*
 *	CFBamXMsgRspnDelSubDep2Updated XML SAX Element  implementation
 *	for DelSubDep2.
 */
public class CFBamXMsgRspnDelSubDep2Updated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep2Updated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelSubDep2Updated" );
