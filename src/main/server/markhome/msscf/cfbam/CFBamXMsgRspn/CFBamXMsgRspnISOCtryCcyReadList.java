...
/*
 *	CFBamXMsgRspnISOCtryCcyReadList XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFBamXMsgRspnISOCtryCcyReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryCcyReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCtryCcyReadList" );
			...
			List<ICFSecISOCtryCcyObj> sortedList =
				new ArrayList<ICFSecISOCtryCcyObj>();
