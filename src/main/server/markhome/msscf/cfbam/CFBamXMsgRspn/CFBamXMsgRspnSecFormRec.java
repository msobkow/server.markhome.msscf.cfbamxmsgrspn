...
/*
 *	CFBamXMsgRspnSecFormRec XML SAX Element  implementation
 *	for SecForm.
 */
public class CFBamXMsgRspnSecFormRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecFormRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecSecFormObj> list =
				(List<ICFSecSecFormObj>)xmsgRspn.getListOfObjects();
