...
/*
 *	CFBamXMsgRspnSchemaDefReadSingle XML SAX Element  implementation
 *	for SchemaDef.
 */
public class CFBamXMsgRspnSchemaDefReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSchemaDefReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSchemaDefReadSingle" );
