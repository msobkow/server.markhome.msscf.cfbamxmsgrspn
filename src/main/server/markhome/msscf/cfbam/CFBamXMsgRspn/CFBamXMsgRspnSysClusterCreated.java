...
/*
 *	CFBamXMsgRspnSysClusterCreated XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFBamXMsgRspnSysClusterCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSysClusterCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSysClusterCreated" );
