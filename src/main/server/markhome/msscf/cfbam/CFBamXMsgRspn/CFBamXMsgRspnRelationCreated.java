...
/*
 *	CFBamXMsgRspnRelationCreated XML SAX Element  implementation
 *	for Relation.
 */
public class CFBamXMsgRspnRelationCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnRelationCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
