...
/*
 *	CFBamXMsgRspnSecGrpMembLocked XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFBamXMsgRspnSecGrpMembLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGrpMembLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecGrpMembLocked" );
