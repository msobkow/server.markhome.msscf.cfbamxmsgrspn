...
/*
 *	CFBamXMsgRspnSecSessionRec XML SAX Element  implementation
 *	for SecSession.
 */
public class CFBamXMsgRspnSecSessionRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecSessionRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
