...
/*
 *	CFBamXMsgRspnTextDefCreated XML SAX Element  implementation
 *	for TextDef.
 */
public class CFBamXMsgRspnTextDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTextDefCreated" );
