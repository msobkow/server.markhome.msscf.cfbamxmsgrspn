...
// Description: Java 11 XML Message SAX Response Record Element  for TopDomain
...
/*
 *	CFBamXMsgRspnTopDomainUpdated XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFBamXMsgRspnTopDomainUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTopDomainUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTopDomainUpdated" );
			...
			CFIntTopDomainBuff dataBuff = obj.getTopDomainBuff();
			...
			obj.copyBuffToPKey();
			ICFBamTopDomainObj realised = (ICFBamTopDomainObj)obj.realise();
