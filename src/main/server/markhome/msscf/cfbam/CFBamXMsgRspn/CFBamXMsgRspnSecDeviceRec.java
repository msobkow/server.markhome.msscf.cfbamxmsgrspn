...
/*
 *	CFBamXMsgRspnSecDeviceRec XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFBamXMsgRspnSecDeviceRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecDeviceRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecSecDeviceObj> list =
				(List<ICFSecSecDeviceObj>)xmsgRspn.getListOfObjects();
