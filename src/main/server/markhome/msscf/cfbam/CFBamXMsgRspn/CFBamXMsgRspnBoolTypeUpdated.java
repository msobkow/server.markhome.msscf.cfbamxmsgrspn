...
/*
 *	CFBamXMsgRspnBoolTypeUpdated XML SAX Element  implementation
 *	for BoolType.
 */
public class CFBamXMsgRspnBoolTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBoolTypeUpdated" );
