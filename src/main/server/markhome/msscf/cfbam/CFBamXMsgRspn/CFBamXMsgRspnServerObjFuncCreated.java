...
/*
 *	CFBamXMsgRspnServerObjFuncCreated XML SAX Element  implementation
 *	for ServerObjFunc.
 */
public class CFBamXMsgRspnServerObjFuncCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerObjFuncCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerObjFuncCreated" );
