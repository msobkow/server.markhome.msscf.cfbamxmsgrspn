...
/*
 *	CFBamXMsgRspnClearSubDep2Created XML SAX Element  implementation
 *	for ClearSubDep2.
 */
public class CFBamXMsgRspnClearSubDep2Created
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep2Created( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearSubDep2Created" );
