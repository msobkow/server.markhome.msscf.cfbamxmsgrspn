...
/*
 *	CFBamXMsgRspnSecSessionLocked XML SAX Element  implementation
 *	for SecSession.
 */
public class CFBamXMsgRspnSecSessionLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecSessionLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
