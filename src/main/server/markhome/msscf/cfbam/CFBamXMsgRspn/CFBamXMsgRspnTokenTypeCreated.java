...
/*
 *	CFBamXMsgRspnTokenTypeCreated XML SAX Element  implementation
 *	for TokenType.
 */
public class CFBamXMsgRspnTokenTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTokenTypeCreated" );
