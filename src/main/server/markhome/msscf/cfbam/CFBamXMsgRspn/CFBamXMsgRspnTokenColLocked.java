...
/*
 *	CFBamXMsgRspnTokenColLocked XML SAX Element  implementation
 *	for TokenCol.
 */
public class CFBamXMsgRspnTokenColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTokenColLocked" );
