...
/*
 *	CFBamXMsgRspnISOCtryCcyUpdated XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFBamXMsgRspnISOCtryCcyUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryCcyUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCtryCcyUpdated" );
			...
			ICFBamISOCtryCcyObj obj = (ICFBamISOCtryCcyObj)schemaObj.getISOCtryCcyTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFBamISOCtryCcyObj realised = (ICFBamISOCtryCcyObj)obj.realise();
