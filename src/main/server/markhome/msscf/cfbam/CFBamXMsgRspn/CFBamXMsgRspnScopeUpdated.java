...
/*
 *	CFBamXMsgRspnScopeUpdated XML SAX Element  implementation
 *	for Scope.
 */
public class CFBamXMsgRspnScopeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnScopeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnScopeUpdated" );
