...
/*
 *	CFBamXMsgRspnTZTimestampColRec XML SAX Element  implementation
 *	for TZTimestampCol.
 */
public class CFBamXMsgRspnTZTimestampColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
