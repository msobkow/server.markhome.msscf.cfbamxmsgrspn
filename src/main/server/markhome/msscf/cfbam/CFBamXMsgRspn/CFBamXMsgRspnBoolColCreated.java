...
/*
 *	CFBamXMsgRspnBoolColCreated XML SAX Element  implementation
 *	for BoolCol.
 */
public class CFBamXMsgRspnBoolColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBoolColCreated" );
