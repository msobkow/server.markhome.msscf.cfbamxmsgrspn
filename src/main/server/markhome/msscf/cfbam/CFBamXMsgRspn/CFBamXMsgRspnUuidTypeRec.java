...
// Description: Java 11 XML Message SAX Response Record Element  for UuidType
...
/*
 *	CFBamXMsgRspnUuidTypeRec XML SAX Element  implementation
 *	for UuidType.
 */
public class CFBamXMsgRspnUuidTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamUuidTypeBuff dataBuff = obj.getUuidTypeBuff();
