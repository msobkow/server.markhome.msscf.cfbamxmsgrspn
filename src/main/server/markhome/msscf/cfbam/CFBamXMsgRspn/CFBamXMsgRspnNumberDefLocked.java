...
/*
 *	CFBamXMsgRspnNumberDefLocked XML SAX Element  implementation
 *	for NumberDef.
 */
public class CFBamXMsgRspnNumberDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNumberDefLocked" );
