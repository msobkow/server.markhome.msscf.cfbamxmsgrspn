...
// Description: Java 11 XML Message SAX Response Record Element  for TZTimeCol
...
/*
 *	CFBamXMsgRspnTZTimeColRec XML SAX Element  implementation
 *	for TZTimeCol.
 */
public class CFBamXMsgRspnTZTimeColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamTZTimeColBuff dataBuff = obj.getTZTimeColBuff();
