...
/*
 *	CFBamXMsgRspnScopeLocked XML SAX Element  implementation
 *	for Scope.
 */
public class CFBamXMsgRspnScopeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnScopeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnScopeLocked" );
