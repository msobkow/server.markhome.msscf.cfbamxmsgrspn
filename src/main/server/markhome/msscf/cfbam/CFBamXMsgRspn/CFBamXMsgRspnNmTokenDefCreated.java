...
/*
 *	CFBamXMsgRspnNmTokenDefCreated XML SAX Element  implementation
 *	for NmTokenDef.
 */
public class CFBamXMsgRspnNmTokenDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokenDefCreated" );
