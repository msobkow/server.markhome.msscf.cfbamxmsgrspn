...
/*
 *	CFBamXMsgRspnNmTokensColLocked XML SAX Element  implementation
 *	for NmTokensCol.
 */
public class CFBamXMsgRspnNmTokensColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokensColLocked" );
