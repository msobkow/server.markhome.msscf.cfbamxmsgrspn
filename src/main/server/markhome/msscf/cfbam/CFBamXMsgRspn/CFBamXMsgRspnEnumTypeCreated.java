...
/*
 *	CFBamXMsgRspnEnumTypeCreated XML SAX Element  implementation
 *	for EnumType.
 */
public class CFBamXMsgRspnEnumTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnEnumTypeCreated" );
