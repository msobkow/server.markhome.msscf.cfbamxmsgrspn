...
/*
 *	CFBamXMsgRspnURLProtocolCreated XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFBamXMsgRspnURLProtocolCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnURLProtocolCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnURLProtocolCreated" );
