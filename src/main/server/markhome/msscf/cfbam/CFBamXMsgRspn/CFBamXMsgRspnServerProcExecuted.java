...
/*
 *	CFBamXMsgRspnServerProcExecuted XML SAX Element  implementation
 */
public class CFBamXMsgRspnServerProcExecuted
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerProcExecuted( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
