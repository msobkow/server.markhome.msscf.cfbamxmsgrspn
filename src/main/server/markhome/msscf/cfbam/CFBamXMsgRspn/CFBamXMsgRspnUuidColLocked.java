...
/*
 *	CFBamXMsgRspnUuidColLocked XML SAX Element  implementation
 *	for UuidCol.
 */
public class CFBamXMsgRspnUuidColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidColLocked" );
