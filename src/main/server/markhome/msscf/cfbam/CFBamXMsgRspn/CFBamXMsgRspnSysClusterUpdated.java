...
/*
 *	CFBamXMsgRspnSysClusterUpdated XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFBamXMsgRspnSysClusterUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSysClusterUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSysClusterUpdated" );
			...
			ICFBamSysClusterObj obj = (ICFBamSysClusterObj)schemaObj.getSysClusterTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFBamSysClusterObj realised = (ICFBamSysClusterObj)obj.realise();
