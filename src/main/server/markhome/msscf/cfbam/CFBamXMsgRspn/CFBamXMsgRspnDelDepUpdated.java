...
/*
 *	CFBamXMsgRspnDelDepUpdated XML SAX Element  implementation
 *	for DelDep.
 */
public class CFBamXMsgRspnDelDepUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelDepUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelDepUpdated" );
