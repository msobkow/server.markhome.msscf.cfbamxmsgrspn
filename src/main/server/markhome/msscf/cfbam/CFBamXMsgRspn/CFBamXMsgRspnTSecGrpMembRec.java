...
/*
 *	CFBamXMsgRspnTSecGrpMembRec XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFBamXMsgRspnTSecGrpMembRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGrpMembRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecTSecGrpMembObj> list =
				(List<ICFSecTSecGrpMembObj>)xmsgRspn.getListOfObjects();
