...
// Description: Java 11 XML Message SAX Response Record Element  for NmTokensDef
...
/*
 *	CFBamXMsgRspnNmTokensDefUpdated XML SAX Element  implementation
 *	for NmTokensDef.
 */
public class CFBamXMsgRspnNmTokensDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokensDefUpdated" );
			...
			ICFBamNmTokensDefObj obj = (ICFBamNmTokensDefObj)schemaObj.getNmTokensDefTableObj().newInstance();
			CFBamNmTokensDefBuff dataBuff = obj.getNmTokensDefBuff();
