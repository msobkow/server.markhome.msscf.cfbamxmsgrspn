...
/*
 *	CFBamXMsgRspnISOCtryLangLocked XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFBamXMsgRspnISOCtryLangLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryLangLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCtryLangLocked" );
