...
/*
 *	CFBamXMsgRspnTokenDefUpdated XML SAX Element  implementation
 *	for TokenDef.
 */
public class CFBamXMsgRspnTokenDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTokenDefUpdated" );
