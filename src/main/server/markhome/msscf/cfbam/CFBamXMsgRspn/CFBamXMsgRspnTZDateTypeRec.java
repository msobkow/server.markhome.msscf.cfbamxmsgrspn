...
// Description: Java 11 XML Message SAX Response Record Element  for TZDateType
...
/*
 *	CFBamXMsgRspnTZDateTypeRec XML SAX Element  implementation
 *	for TZDateType.
 */
public class CFBamXMsgRspnTZDateTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "TZDateType" );
			...
			CFBamTZDateTypeBuff dataBuff = obj.getTZDateTypeBuff();
