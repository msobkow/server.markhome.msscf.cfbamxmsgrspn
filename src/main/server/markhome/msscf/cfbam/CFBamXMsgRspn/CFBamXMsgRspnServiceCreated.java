...
/*
 *	CFBamXMsgRspnServiceCreated XML SAX Element  implementation
 *	for Service.
 */
public class CFBamXMsgRspnServiceCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServiceCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServiceCreated" );
