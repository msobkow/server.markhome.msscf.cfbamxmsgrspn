...
/*
 *	CFBamXMsgRspnAtomCreated XML SAX Element  implementation
 *	for Atom.
 */
public class CFBamXMsgRspnAtomCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnAtomCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnAtomCreated" );
