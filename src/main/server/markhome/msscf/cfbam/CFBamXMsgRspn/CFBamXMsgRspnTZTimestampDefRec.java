...
// Description: Java 11 XML Message SAX Response Record Element  for TZTimestampDef
...
/*
 *	CFBamXMsgRspnTZTimestampDefRec XML SAX Element  implementation
 *	for TZTimestampDef.
 */
public class CFBamXMsgRspnTZTimestampDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "TZTimestampDef" );
			...
			ICFBamTZTimestampDefObj obj = (ICFBamTZTimestampDefObj)(schemaObj.getTZTimestampDefTableObj().newInstance());
			CFBamTZTimestampDefBuff dataBuff = obj.getTZTimestampDefBuff();
			...
			dataBuff.setOptionalDummy( natDummy );
			obj.copyBuffToPKey();
