...
/*
 *	CFBamXMsgRspnDateDefLocked XML SAX Element  implementation
 *	for DateDef.
 */
public class CFBamXMsgRspnDateDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDateDefLocked" );
