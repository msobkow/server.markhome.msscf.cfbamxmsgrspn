...
// Description: Java 11 XML Message SAX Response Record Element  for NumberCol
...
/*
 *	CFBamXMsgRspnNumberColRec XML SAX Element  implementation
 *	for NumberCol.
 */
public class CFBamXMsgRspnNumberColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamNumberColBuff dataBuff = obj.getNumberColBuff();
