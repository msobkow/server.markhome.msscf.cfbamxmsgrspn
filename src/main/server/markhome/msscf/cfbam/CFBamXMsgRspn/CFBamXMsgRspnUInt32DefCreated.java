...
/*
 *	CFBamXMsgRspnUInt32DefCreated XML SAX Element  implementation
 *	for UInt32Def.
 */
public class CFBamXMsgRspnUInt32DefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32DefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt32DefCreated" );
