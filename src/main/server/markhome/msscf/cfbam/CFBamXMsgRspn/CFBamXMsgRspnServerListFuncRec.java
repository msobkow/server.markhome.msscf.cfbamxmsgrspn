...
/*
 *	CFBamXMsgRspnServerListFuncRec XML SAX Element  implementation
 *	for ServerListFunc.
 */
public class CFBamXMsgRspnServerListFuncRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerListFuncRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
