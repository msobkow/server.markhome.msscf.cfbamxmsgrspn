...
/*
 *	CFBamXMsgRspnClearDepLocked XML SAX Element  implementation
 *	for ClearDep.
 */
public class CFBamXMsgRspnClearDepLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearDepLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearDepLocked" );
