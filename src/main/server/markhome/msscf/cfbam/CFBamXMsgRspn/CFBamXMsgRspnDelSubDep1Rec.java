...
// Description: Java 11 XML Message SAX Response Record Element  for DelSubDep1
...
/*
 *	CFBamXMsgRspnDelSubDep1Rec XML SAX Element  implementation
 *	for DelSubDep1.
 */
public class CFBamXMsgRspnDelSubDep1Rec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep1Rec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			// DelSubDep1 Attributes
			String	attrDelTopDepTenantId = null;
			String	attrDelTopDepId = null;
			...
			assert qName.equals( "DelSubDep1" );
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "DelTopDepTenantId" ) ) {
					if( attrDelTopDepTenantId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrDelTopDepTenantId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "DelTopDepId" ) ) {
					if( attrDelTopDepId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrDelTopDepId = attrs.getValue( idxAttr );
				}
			...
			if( ( attrDelTopDepTenantId == null ) || ( attrDelTopDepTenantId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"DelTopDepTenantId" );
			}
			if( ( attrDelTopDepId == null ) || ( attrDelTopDepId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"DelTopDepId" );
			...
			long natDelTopDepTenantId = Long.parseLong( attrDelTopDepTenantId );

			long natDelTopDepId = Long.parseLong( attrDelTopDepId );
			...
			CFBamDelSubDep1Buff dataBuff = obj.getDelSubDep1Buff();
			...
			dataBuff.setRequiredDelTopDepTenantId( natDelTopDepTenantId );
			dataBuff.setRequiredDelTopDepId( natDelTopDepId );
