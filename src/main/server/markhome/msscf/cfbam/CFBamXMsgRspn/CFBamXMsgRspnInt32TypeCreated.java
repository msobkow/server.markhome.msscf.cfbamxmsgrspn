...
// Description: Java 11 XML Message SAX Response Record Element  for Int32Type
...
/*
 *	CFBamXMsgRspnInt32TypeCreated XML SAX Element  implementation
 *	for Int32Type.
 */
public class CFBamXMsgRspnInt32TypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32TypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt32TypeCreated" );
			...
			CFBamInt32TypeBuff dataBuff = obj.getInt32TypeBuff();
