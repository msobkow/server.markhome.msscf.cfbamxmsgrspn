...
/*
 *	CFBamXMsgRspnISOCtryLangReadList XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFBamXMsgRspnISOCtryLangReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryLangReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCtryLangReadList" );
			...
			List<ICFSecISOCtryLangObj> sortedList =
				new ArrayList<ICFSecISOCtryLangObj>();
