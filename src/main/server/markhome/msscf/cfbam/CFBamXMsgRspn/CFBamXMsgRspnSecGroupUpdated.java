...
/*
 *	CFBamXMsgRspnSecGroupUpdated XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFBamXMsgRspnSecGroupUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGroupUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecGroupUpdated" );
