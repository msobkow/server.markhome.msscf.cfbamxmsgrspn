...
/*
 *	CFBamXMsgRspnNoDataFound XML SAX Element  implementation
 */
public class CFBamXMsgRspnNoDataFound
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNoDataFound( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			xmsgRspn.setLastObjectProcessed( null );
		}
