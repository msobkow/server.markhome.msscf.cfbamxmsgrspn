...
/*
 *	CFBamXMsgRspnTSecGrpMembUpdated XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFBamXMsgRspnTSecGrpMembUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGrpMembUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGrpMembUpdated" );
