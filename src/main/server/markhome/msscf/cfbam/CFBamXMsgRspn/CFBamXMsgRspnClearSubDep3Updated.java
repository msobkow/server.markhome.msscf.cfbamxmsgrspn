...
/*
 *	CFBamXMsgRspnClearSubDep3Updated XML SAX Element  implementation
 *	for ClearSubDep3.
 */
public class CFBamXMsgRspnClearSubDep3Updated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep3Updated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearSubDep3Updated" );
