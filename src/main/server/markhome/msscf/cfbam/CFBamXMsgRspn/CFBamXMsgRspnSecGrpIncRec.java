...
/*
 *	CFBamXMsgRspnSecGrpIncRec XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFBamXMsgRspnSecGrpIncRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGrpIncRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecSecGrpIncObj> list =
				(List<ICFSecSecGrpIncObj>)xmsgRspn.getListOfObjects();
