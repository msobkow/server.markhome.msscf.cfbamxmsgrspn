...
// Description: Java 11 XML Message SAX Response Record Element  for DelDep
...
/*
 *	CFBamXMsgRspnDelDepRec XML SAX Element  implementation
 *	for DelDep.
 */
public class CFBamXMsgRspnDelDepRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelDepRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDelDepObj obj = (ICFBamDelDepObj)(schemaObj.getDelDepTableObj().newInstance());
			CFBamDelDepBuff dataBuff = obj.getDelDepBuff();
