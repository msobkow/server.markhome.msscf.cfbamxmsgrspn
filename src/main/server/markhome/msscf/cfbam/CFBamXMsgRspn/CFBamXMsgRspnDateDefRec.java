...
// Description: Java 11 XML Message SAX Response Record Element  for DateDef
...
/*
 *	CFBamXMsgRspnDateDefRec XML SAX Element  implementation
 *	for DateDef.
 */
public class CFBamXMsgRspnDateDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDateDefObj obj = (ICFBamDateDefObj)(schemaObj.getDateDefTableObj().newInstance());
			CFBamDateDefBuff dataBuff = obj.getDateDefBuff();
