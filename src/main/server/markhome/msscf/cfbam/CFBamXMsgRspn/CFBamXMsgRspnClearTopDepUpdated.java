...
/*
 *	CFBamXMsgRspnClearTopDepUpdated XML SAX Element  implementation
 *	for ClearTopDep.
 */
public class CFBamXMsgRspnClearTopDepUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearTopDepUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearTopDepUpdated" );
