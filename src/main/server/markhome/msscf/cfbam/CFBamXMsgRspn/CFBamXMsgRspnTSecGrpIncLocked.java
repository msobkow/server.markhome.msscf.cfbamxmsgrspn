...
/*
 *	CFBamXMsgRspnTSecGrpIncLocked XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFBamXMsgRspnTSecGrpIncLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGrpIncLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGrpIncLocked" );
