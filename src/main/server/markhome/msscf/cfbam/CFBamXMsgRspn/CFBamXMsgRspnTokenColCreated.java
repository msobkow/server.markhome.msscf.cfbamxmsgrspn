...
/*
 *	CFBamXMsgRspnTokenColCreated XML SAX Element  implementation
 *	for TokenCol.
 */
public class CFBamXMsgRspnTokenColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTokenColCreated" );
