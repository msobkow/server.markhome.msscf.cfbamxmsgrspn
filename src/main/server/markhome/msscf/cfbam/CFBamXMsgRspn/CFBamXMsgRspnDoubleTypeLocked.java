...
/*
 *	CFBamXMsgRspnDoubleTypeLocked XML SAX Element  implementation
 *	for DoubleType.
 */
public class CFBamXMsgRspnDoubleTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDoubleTypeLocked" );
