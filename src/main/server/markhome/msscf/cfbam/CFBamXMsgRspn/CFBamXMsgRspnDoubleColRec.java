...
// Description: Java 11 XML Message SAX Response Record Element  for DoubleCol
...
/*
 *	CFBamXMsgRspnDoubleColRec XML SAX Element  implementation
 *	for DoubleCol.
 */
public class CFBamXMsgRspnDoubleColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamDoubleColBuff dataBuff = obj.getDoubleColBuff();
