...
/*
 *	CFBamXMsgRspnStringColUpdated XML SAX Element  implementation
 *	for StringCol.
 */
public class CFBamXMsgRspnStringColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnStringColUpdated" );
