...
/*
 *	CFBamXMsgRspnSecAppLocked XML SAX Element  implementation
 *	for SecApp.
 */
public class CFBamXMsgRspnSecAppLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecAppLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecAppLocked" );
