...
/*
 *	CFBamXMsgRspnHostNodeReadList XML SAX Element  implementation
 *	for HostNode.
 */
public class CFBamXMsgRspnHostNodeReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnHostNodeReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnHostNodeReadList" );
			...
			List<ICFSecHostNodeObj> sortedList =
				new ArrayList<ICFSecHostNodeObj>();
