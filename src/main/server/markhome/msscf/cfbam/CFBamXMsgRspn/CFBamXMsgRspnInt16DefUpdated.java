...
/*
 *	CFBamXMsgRspnInt16DefUpdated XML SAX Element  implementation
 *	for Int16Def.
 */
public class CFBamXMsgRspnInt16DefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16DefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt16DefUpdated" );
