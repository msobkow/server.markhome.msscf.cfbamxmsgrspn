...
/*
 *	CFBamXMsgRspnClearSubDep2Updated XML SAX Element  implementation
 *	for ClearSubDep2.
 */
public class CFBamXMsgRspnClearSubDep2Updated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep2Updated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearSubDep2Updated" );
