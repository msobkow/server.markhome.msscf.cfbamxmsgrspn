...
/*
 *	CFBamXMsgRspnRelationColUpdated XML SAX Element  implementation
 *	for RelationCol.
 */
public class CFBamXMsgRspnRelationColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnRelationColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnRelationColUpdated" );
