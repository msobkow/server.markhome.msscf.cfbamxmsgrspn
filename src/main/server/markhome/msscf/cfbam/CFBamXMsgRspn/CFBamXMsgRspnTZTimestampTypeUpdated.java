...
/*
 *	CFBamXMsgRspnTZTimestampTypeUpdated XML SAX Element  implementation
 *	for TZTimestampType.
 */
public class CFBamXMsgRspnTZTimestampTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimestampTypeUpdated" );
