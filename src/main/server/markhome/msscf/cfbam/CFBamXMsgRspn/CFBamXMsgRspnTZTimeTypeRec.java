...
/*
 *	CFBamXMsgRspnTZTimeTypeRec XML SAX Element  implementation
 *	for TZTimeType.
 */
public class CFBamXMsgRspnTZTimeTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
