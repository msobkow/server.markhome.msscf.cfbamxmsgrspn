...
/*
 *	CFBamXMsgRspnSubProjectReadList XML SAX Element  implementation
 *	for SubProject.
 */
public class CFBamXMsgRspnSubProjectReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSubProjectReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSubProjectReadList" );
			...
			List<ICFIntSubProjectObj> sortedList =
				new ArrayList<ICFIntSubProjectObj>();
