...
/*
 *	CFBamXMsgRspnTextColCreated XML SAX Element  implementation
 *	for TextCol.
 */
public class CFBamXMsgRspnTextColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTextColCreated" );
