...
/*
 *	CFBamXMsgRspnStringDefCreated XML SAX Element  implementation
 *	for StringDef.
 */
public class CFBamXMsgRspnStringDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnStringDefCreated" );
