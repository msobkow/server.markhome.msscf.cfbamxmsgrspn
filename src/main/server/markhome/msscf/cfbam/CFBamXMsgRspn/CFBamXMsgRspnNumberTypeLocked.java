...
/*
 *	CFBamXMsgRspnNumberTypeLocked XML SAX Element  implementation
 *	for NumberType.
 */
public class CFBamXMsgRspnNumberTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNumberTypeLocked" );
