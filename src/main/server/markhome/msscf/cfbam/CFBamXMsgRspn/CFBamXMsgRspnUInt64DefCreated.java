...
/*
 *	CFBamXMsgRspnUInt64DefCreated XML SAX Element  implementation
 *	for UInt64Def.
 */
public class CFBamXMsgRspnUInt64DefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64DefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt64DefCreated" );
