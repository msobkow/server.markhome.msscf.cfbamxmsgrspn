...
// Description: Java 11 XML Message SAX Response Record Element  for UuidGen
...
/*
 *	CFBamXMsgRspnUuidGenRec XML SAX Element  implementation
 *	for UuidGen.
 */
public class CFBamXMsgRspnUuidGenRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidGenRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamUuidGenBuff dataBuff = obj.getUuidGenBuff();
