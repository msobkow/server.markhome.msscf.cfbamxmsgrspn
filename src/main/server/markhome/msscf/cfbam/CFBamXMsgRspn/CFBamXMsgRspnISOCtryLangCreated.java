...
/*
 *	CFBamXMsgRspnISOCtryLangCreated XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFBamXMsgRspnISOCtryLangCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryLangCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCtryLangCreated" );
			...
			ICFBamISOCtryLangObj obj = (ICFBamISOCtryLangObj)schemaObj.getISOCtryLangTableObj().newInstance();
			CFSecISOCtryLangBuff dataBuff = obj.getISOCtryLangBuff();
			...
			obj.copyBuffToPKey();
			ICFBamISOCtryLangObj realised = (ICFBamISOCtryLangObj)obj.realise();
