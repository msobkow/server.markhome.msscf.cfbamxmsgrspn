...
/*
 *	CFBamXMsgRspnUInt32ColUpdated XML SAX Element  implementation
 *	for UInt32Col.
 */
public class CFBamXMsgRspnUInt32ColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32ColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt32ColUpdated" );
