...
/*
 *	CFBamXMsgRspnTextDefLocked XML SAX Element  implementation
 *	for TextDef.
 */
public class CFBamXMsgRspnTextDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTextDefLocked" );
