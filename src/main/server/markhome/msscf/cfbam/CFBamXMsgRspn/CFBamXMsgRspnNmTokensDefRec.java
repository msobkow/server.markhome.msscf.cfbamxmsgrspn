...
/*
 *	CFBamXMsgRspnNmTokensDefRec XML SAX Element  implementation
 *	for NmTokensDef.
 */
public class CFBamXMsgRspnNmTokensDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
