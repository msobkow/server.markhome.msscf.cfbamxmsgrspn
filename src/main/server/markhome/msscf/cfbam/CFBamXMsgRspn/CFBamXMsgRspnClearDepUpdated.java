...
/*
 *	CFBamXMsgRspnClearDepUpdated XML SAX Element  implementation
 *	for ClearDep.
 */
public class CFBamXMsgRspnClearDepUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearDepUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearDepUpdated" );
