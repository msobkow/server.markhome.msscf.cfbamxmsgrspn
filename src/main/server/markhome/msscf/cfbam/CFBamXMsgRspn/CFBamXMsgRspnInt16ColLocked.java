...
/*
 *	CFBamXMsgRspnInt16ColLocked XML SAX Element  implementation
 *	for Int16Col.
 */
public class CFBamXMsgRspnInt16ColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16ColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt16ColLocked" );
