...
/*
 *	CFBamXMsgRspnUInt16ColCreated XML SAX Element  implementation
 *	for UInt16Col.
 */
public class CFBamXMsgRspnUInt16ColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16ColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt16ColCreated" );
