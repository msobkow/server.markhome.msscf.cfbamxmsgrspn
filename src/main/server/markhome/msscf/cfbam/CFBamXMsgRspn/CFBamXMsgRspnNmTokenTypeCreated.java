...
/*
 *	CFBamXMsgRspnNmTokenTypeCreated XML SAX Element  implementation
 *	for NmTokenType.
 */
public class CFBamXMsgRspnNmTokenTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokenTypeCreated" );
