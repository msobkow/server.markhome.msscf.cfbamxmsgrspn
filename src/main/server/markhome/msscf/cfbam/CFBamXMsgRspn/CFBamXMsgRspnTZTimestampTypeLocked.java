...
/*
 *	CFBamXMsgRspnTZTimestampTypeLocked XML SAX Element  implementation
 *	for TZTimestampType.
 */
public class CFBamXMsgRspnTZTimestampTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimestampTypeLocked" );
