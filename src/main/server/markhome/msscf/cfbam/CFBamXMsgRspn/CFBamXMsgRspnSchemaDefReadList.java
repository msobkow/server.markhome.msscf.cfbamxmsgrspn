...
/*
 *	CFBamXMsgRspnSchemaDefReadList XML SAX Element  implementation
 *	for SchemaDef.
 */
public class CFBamXMsgRspnSchemaDefReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSchemaDefReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSchemaDefReadList" );
