...
/*
 *	CFBamXMsgRspnNmTokensColCreated XML SAX Element  implementation
 *	for NmTokensCol.
 */
public class CFBamXMsgRspnNmTokensColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokensColCreated" );
