...
/*
 *	CFBamXMsgRspnInt16ColUpdated XML SAX Element  implementation
 *	for Int16Col.
 */
public class CFBamXMsgRspnInt16ColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16ColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt16ColUpdated" );
