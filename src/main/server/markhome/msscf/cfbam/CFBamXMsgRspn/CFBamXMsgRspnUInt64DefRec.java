...
// Description: Java 11 XML Message SAX Response Record Element  for UInt64Def
...
/*
 *	CFBamXMsgRspnUInt64DefRec XML SAX Element  implementation
 *	for UInt64Def.
 */
public class CFBamXMsgRspnUInt64DefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64DefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt64DefObj obj = (ICFBamUInt64DefObj)(schemaObj.getUInt64DefTableObj().newInstance());
			CFBamUInt64DefBuff dataBuff = obj.getUInt64DefBuff();
