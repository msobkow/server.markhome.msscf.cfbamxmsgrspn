...
// Description: Java 11 XML Message SAX Response Record Element  for BlobDef
...
/*
 *	CFBamXMsgRspnBlobDefRec XML SAX Element  implementation
 *	for BlobDef.
 */
public class CFBamXMsgRspnBlobDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBlobDefObj obj = (ICFBamBlobDefObj)(schemaObj.getBlobDefTableObj().newInstance());
			CFBamBlobDefBuff dataBuff = obj.getBlobDefBuff();
