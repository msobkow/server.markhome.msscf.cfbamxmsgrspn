...
/*
 *	CFBamXMsgRspnTextTypeCreated XML SAX Element  implementation
 *	for TextType.
 */
public class CFBamXMsgRspnTextTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTextTypeCreated" );
