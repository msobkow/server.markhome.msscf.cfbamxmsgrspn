...
/*
 *	CFBamXMsgRspnPopSubDep3Locked XML SAX Element  implementation
 *	for PopSubDep3.
 */
public class CFBamXMsgRspnPopSubDep3Locked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep3Locked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopSubDep3Locked" );
