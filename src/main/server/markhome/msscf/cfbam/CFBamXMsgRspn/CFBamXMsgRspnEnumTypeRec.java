...
// Description: Java 11 XML Message SAX Response Record Element  for EnumType
...
/*
 *	CFBamXMsgRspnEnumTypeRec XML SAX Element  implementation
 *	for EnumType.
 */
public class CFBamXMsgRspnEnumTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamEnumTypeBuff dataBuff = obj.getEnumTypeBuff();
