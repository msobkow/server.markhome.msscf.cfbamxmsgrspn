...
// Description: Java 11 XML Message SAX Response Record Element  for TokenCol
...
/*
 *	CFBamXMsgRspnTokenColRec XML SAX Element  implementation
 *	for TokenCol.
 */
public class CFBamXMsgRspnTokenColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamTokenColBuff dataBuff = obj.getTokenColBuff();
