...
/*
 *	CFBamXMsgRspnSchemaDefUpdated XML SAX Element  implementation
 *	for SchemaDef.
 */
public class CFBamXMsgRspnSchemaDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSchemaDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSchemaDefUpdated" );
