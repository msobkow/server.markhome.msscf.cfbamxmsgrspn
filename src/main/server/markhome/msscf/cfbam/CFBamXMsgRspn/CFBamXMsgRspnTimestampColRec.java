...
// Description: Java 11 XML Message SAX Response Record Element  for TimestampCol
...
/*
 *	CFBamXMsgRspnTimestampColRec XML SAX Element  implementation
 *	for TimestampCol.
 */
public class CFBamXMsgRspnTimestampColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "TimestampCol" );
			...
			CFBamTimestampColBuff dataBuff = obj.getTimestampColBuff();
