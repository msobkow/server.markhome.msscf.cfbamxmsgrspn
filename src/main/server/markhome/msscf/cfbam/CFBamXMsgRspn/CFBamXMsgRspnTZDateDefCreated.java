...
/*
 *	CFBamXMsgRspnTZDateDefCreated XML SAX Element  implementation
 *	for TZDateDef.
 */
public class CFBamXMsgRspnTZDateDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZDateDefCreated" );
