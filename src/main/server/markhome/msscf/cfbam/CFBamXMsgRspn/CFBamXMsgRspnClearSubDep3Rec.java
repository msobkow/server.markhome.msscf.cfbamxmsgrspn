...
/*
 *	CFBamXMsgRspnClearSubDep3Rec XML SAX Element  implementation
 *	for ClearSubDep3.
 */
public class CFBamXMsgRspnClearSubDep3Rec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep3Rec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "ClearSubDep3" );
