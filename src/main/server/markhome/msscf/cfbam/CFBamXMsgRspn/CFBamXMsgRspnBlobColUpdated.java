...
/*
 *	CFBamXMsgRspnBlobColUpdated XML SAX Element  implementation
 *	for BlobCol.
 */
public class CFBamXMsgRspnBlobColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobColUpdated" );
