...
/*
 *	CFBamXMsgRspnTopDomainCreated XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFBamXMsgRspnTopDomainCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTopDomainCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTopDomainCreated" );
