...
/*
 *	CFBamXMsgRspnId16GenUpdated XML SAX Element  implementation
 *	for Id16Gen.
 */
public class CFBamXMsgRspnId16GenUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnId16GenUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnId16GenUpdated" );
