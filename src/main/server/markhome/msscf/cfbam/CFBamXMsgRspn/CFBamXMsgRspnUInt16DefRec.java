...
// Description: Java 11 XML Message SAX Response Record Element  for UInt16Def
...
/*
 *	CFBamXMsgRspnUInt16DefRec XML SAX Element  implementation
 *	for UInt16Def.
 */
public class CFBamXMsgRspnUInt16DefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16DefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt16DefObj obj = (ICFBamUInt16DefObj)(schemaObj.getUInt16DefTableObj().newInstance());
			CFBamUInt16DefBuff dataBuff = obj.getUInt16DefBuff();
