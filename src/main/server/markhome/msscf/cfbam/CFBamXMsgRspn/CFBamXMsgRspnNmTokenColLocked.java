...
/*
 *	CFBamXMsgRspnNmTokenColLocked XML SAX Element  implementation
 *	for NmTokenCol.
 */
public class CFBamXMsgRspnNmTokenColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokenColLocked" );
