...
/*
 *	CFBamXMsgRspnHostNodeRec XML SAX Element  implementation
 *	for HostNode.
 */
public class CFBamXMsgRspnHostNodeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnHostNodeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecHostNodeObj> list =
				(List<ICFSecHostNodeObj>)xmsgRspn.getListOfObjects();
