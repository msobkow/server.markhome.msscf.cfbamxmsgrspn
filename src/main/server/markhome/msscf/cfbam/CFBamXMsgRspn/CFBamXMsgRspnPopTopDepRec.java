...
// Description: Java 11 XML Message SAX Response Record Element  for PopTopDep
...
/*
 *	CFBamXMsgRspnPopTopDepRec XML SAX Element  implementation
 *	for PopTopDep.
 */
public class CFBamXMsgRspnPopTopDepRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopTopDepRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			// PopTopDep Attributes
			String	attrContRelationTenantId = null;
			String	attrContRelationId = null;
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "ContRelationTenantId" ) ) {
					if( attrContRelationTenantId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrContRelationTenantId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "ContRelationId" ) ) {
					if( attrContRelationId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrContRelationId = attrs.getValue( idxAttr );
				}
			...
			if( ( attrContRelationTenantId == null ) || ( attrContRelationTenantId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"ContRelationTenantId" );
			}
			if( ( attrContRelationId == null ) || ( attrContRelationId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"ContRelationId" );
			...
			long natContRelationTenantId = Long.parseLong( attrContRelationTenantId );

			long natContRelationId = Long.parseLong( attrContRelationId );
			...
			CFBamPopTopDepBuff dataBuff = obj.getPopTopDepBuff();
			...
			dataBuff.setRequiredContRelationTenantId( natContRelationTenantId );
			dataBuff.setRequiredContRelationId( natContRelationId );
