...
// Description: Java 11 XML Message SAX Response Record Element  for ServerObjFunc
...
/*
 *	CFBamXMsgRspnServerObjFuncRec XML SAX Element  implementation
 *	for ServerObjFunc.
 */
public class CFBamXMsgRspnServerObjFuncRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerObjFuncRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamServerObjFuncBuff dataBuff = obj.getServerObjFuncBuff();
