...
/*
 *	CFBamXMsgRspnClearSubDep1Locked XML SAX Element  implementation
 *	for ClearSubDep1.
 */
public class CFBamXMsgRspnClearSubDep1Locked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep1Locked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearSubDep1Locked" );
