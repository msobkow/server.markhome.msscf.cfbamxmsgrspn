...
/*
 *	CFBamXMsgRspnPopSubDep3Created XML SAX Element  implementation
 *	for PopSubDep3.
 */
public class CFBamXMsgRspnPopSubDep3Created
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep3Created( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopSubDep3Created" );
