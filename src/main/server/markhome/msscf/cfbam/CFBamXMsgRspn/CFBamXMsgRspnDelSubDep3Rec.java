...
/*
 *	CFBamXMsgRspnDelSubDep3Rec XML SAX Element  implementation
 *	for DelSubDep3.
 */
public class CFBamXMsgRspnDelSubDep3Rec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep3Rec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "DelSubDep3" );
