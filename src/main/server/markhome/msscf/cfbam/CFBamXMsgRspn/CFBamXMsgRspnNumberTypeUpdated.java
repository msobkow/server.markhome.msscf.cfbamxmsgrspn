...
/*
 *	CFBamXMsgRspnNumberTypeUpdated XML SAX Element  implementation
 *	for NumberType.
 */
public class CFBamXMsgRspnNumberTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNumberTypeUpdated" );
