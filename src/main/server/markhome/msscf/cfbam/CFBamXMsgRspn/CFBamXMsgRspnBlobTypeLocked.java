...
/*
 *	CFBamXMsgRspnBlobTypeLocked XML SAX Element  implementation
 *	for BlobType.
 */
public class CFBamXMsgRspnBlobTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobTypeLocked" );
