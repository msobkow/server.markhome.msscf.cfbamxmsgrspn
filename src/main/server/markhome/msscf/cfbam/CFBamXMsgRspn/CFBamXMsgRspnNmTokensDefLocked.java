...
/*
 *	CFBamXMsgRspnNmTokensDefLocked XML SAX Element  implementation
 *	for NmTokensDef.
 */
public class CFBamXMsgRspnNmTokensDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokensDefLocked" );
