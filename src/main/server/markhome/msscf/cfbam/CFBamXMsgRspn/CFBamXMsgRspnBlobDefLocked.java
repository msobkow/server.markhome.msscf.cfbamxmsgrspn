...
/*
 *	CFBamXMsgRspnBlobDefLocked XML SAX Element  implementation
 *	for BlobDef.
 */
public class CFBamXMsgRspnBlobDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobDefLocked" );
