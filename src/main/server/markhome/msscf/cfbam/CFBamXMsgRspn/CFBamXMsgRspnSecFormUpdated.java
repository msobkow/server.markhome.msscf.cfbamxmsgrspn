...
/*
 *	CFBamXMsgRspnSecFormUpdated XML SAX Element  implementation
 *	for SecForm.
 */
public class CFBamXMsgRspnSecFormUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecFormUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecFormUpdated" );
