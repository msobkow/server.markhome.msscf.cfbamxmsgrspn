...
/*
 *	CFBamXMsgRspnHostNodeUpdated XML SAX Element  implementation
 *	for HostNode.
 */
public class CFBamXMsgRspnHostNodeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnHostNodeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnHostNodeUpdated" );
			...
			CFSecHostNodeBuff dataBuff = obj.getHostNodeBuff();
			...
			obj.copyBuffToPKey();
			ICFBamHostNodeObj realised = (ICFBamHostNodeObj)obj.realise();
