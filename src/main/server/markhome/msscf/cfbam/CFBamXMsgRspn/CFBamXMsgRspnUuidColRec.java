...
// Description: Java 11 XML Message SAX Response Record Element  for UuidCol
...
/*
 *	CFBamXMsgRspnUuidColRec XML SAX Element  implementation
 *	for UuidCol.
 */
public class CFBamXMsgRspnUuidColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamUuidColBuff dataBuff = obj.getUuidColBuff();
