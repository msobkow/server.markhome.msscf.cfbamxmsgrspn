...
/*
 *	CFBamXMsgRspnSysClusterReadList XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFBamXMsgRspnSysClusterReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSysClusterReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSysClusterReadList" );
			...
			List<ICFSecSysClusterObj> sortedList =
				new ArrayList<ICFSecSysClusterObj>();
