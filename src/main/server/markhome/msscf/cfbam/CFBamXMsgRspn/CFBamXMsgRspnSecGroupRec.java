...
/*
 *	CFBamXMsgRspnSecGroupRec XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFBamXMsgRspnSecGroupRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGroupRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecSecGroupObj> list =
				(List<ICFSecSecGroupObj>)xmsgRspn.getListOfObjects();
