...
/*
 *	CFBamXMsgRspnUuidGenCreated XML SAX Element  implementation
 *	for UuidGen.
 */
public class CFBamXMsgRspnUuidGenCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidGenCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidGenCreated" );
