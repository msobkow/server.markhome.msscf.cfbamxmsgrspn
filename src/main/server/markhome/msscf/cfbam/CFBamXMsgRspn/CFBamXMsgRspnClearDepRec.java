...
// Description: Java 11 XML Message SAX Response Record Element  for ClearDep
...
/*
 *	CFBamXMsgRspnClearDepRec XML SAX Element  implementation
 *	for ClearDep.
 */
public class CFBamXMsgRspnClearDepRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearDepRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamClearDepObj obj = (ICFBamClearDepObj)(schemaObj.getClearDepTableObj().newInstance());
			CFBamClearDepBuff dataBuff = obj.getClearDepBuff();
