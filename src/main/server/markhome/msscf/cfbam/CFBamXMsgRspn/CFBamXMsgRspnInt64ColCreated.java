...
/*
 *	CFBamXMsgRspnInt64ColCreated XML SAX Element  implementation
 *	for Int64Col.
 */
public class CFBamXMsgRspnInt64ColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt64ColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt64ColCreated" );
