...
/*
 *	CFBamXMsgRspnPopDepRec XML SAX Element  implementation
 *	for PopDep.
 */
public class CFBamXMsgRspnPopDepRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopDepRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
