...
/*
 *	CFBamXMsgRspnUInt16TypeCreated XML SAX Element  implementation
 *	for UInt16Type.
 */
public class CFBamXMsgRspnUInt16TypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16TypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt16TypeCreated" );
