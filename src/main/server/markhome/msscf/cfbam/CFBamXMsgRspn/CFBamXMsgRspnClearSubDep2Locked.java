...
/*
 *	CFBamXMsgRspnClearSubDep2Locked XML SAX Element  implementation
 *	for ClearSubDep2.
 */
public class CFBamXMsgRspnClearSubDep2Locked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep2Locked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearSubDep2Locked" );
