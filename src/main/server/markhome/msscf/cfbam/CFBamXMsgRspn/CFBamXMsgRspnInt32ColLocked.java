...
/*
 *	CFBamXMsgRspnInt32ColLocked XML SAX Element  implementation
 *	for Int32Col.
 */
public class CFBamXMsgRspnInt32ColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32ColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt32ColLocked" );
