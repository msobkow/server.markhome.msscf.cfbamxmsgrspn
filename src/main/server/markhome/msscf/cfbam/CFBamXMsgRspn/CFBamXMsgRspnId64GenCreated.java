...
/*
 *	CFBamXMsgRspnId64GenCreated XML SAX Element  implementation
 *	for Id64Gen.
 */
public class CFBamXMsgRspnId64GenCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnId64GenCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnId64GenCreated" );
