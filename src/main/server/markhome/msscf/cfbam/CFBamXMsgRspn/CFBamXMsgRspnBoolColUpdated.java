...
/*
 *	CFBamXMsgRspnBoolColUpdated XML SAX Element  implementation
 *	for BoolCol.
 */
public class CFBamXMsgRspnBoolColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBoolColUpdated" );
