...
/*
 *	CFBamXMsgRspnEnumDefCreated XML SAX Element  implementation
 *	for EnumDef.
 */
public class CFBamXMsgRspnEnumDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnEnumDefCreated" );
