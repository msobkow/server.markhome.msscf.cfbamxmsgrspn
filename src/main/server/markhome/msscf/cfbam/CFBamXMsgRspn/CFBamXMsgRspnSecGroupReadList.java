...
/*
 *	CFBamXMsgRspnSecGroupReadList XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFBamXMsgRspnSecGroupReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGroupReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecGroupReadList" );
			...
			List<ICFSecSecGroupObj> sortedList =
				new ArrayList<ICFSecSecGroupObj>();
