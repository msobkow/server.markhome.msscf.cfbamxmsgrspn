...
/*
 *	CFBamXMsgRspnNumberDefUpdated XML SAX Element  implementation
 *	for NumberDef.
 */
public class CFBamXMsgRspnNumberDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNumberDefUpdated" );
