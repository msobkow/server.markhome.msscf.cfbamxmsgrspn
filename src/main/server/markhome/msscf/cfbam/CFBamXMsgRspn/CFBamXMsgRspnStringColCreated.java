...
/*
 *	CFBamXMsgRspnStringColCreated XML SAX Element  implementation
 *	for StringCol.
 */
public class CFBamXMsgRspnStringColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnStringColCreated" );
