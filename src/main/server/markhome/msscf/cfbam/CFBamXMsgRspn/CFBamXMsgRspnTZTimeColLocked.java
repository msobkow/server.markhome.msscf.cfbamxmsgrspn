...
/*
 *	CFBamXMsgRspnTZTimeColLocked XML SAX Element  implementation
 *	for TZTimeCol.
 */
public class CFBamXMsgRspnTZTimeColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimeColLocked" );
