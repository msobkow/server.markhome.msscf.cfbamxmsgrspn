...
// Description: Java 11 XML Message SAX Response Record Element  for StringCol
...
/*
 *	CFBamXMsgRspnStringColRec XML SAX Element  implementation
 *	for StringCol.
 */
public class CFBamXMsgRspnStringColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamStringColBuff dataBuff = obj.getStringColBuff();
