...
/*
 *	CFBamXMsgRspnPopDepLocked XML SAX Element  implementation
 *	for PopDep.
 */
public class CFBamXMsgRspnPopDepLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopDepLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopDepLocked" );
