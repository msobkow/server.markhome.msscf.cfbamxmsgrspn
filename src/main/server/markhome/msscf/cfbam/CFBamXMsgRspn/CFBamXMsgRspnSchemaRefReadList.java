...
/*
 *	CFBamXMsgRspnSchemaRefReadList XML SAX Element  implementation
 *	for SchemaRef.
 */
public class CFBamXMsgRspnSchemaRefReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSchemaRefReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSchemaRefReadList" );
