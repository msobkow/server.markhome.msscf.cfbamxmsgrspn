...
// Description: Java 11 XML Message SAX Response Record Element  for NmTokensCol
...
/*
 *	CFBamXMsgRspnNmTokensColRec XML SAX Element  implementation
 *	for NmTokensCol.
 */
public class CFBamXMsgRspnNmTokensColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "NmTokensCol" );
			...
			CFBamNmTokensColBuff dataBuff = obj.getNmTokensColBuff();
