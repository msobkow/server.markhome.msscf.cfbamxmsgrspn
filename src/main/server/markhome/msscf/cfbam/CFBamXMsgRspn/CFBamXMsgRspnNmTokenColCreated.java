...
/*
 *	CFBamXMsgRspnNmTokenColCreated XML SAX Element  implementation
 *	for NmTokenCol.
 */
public class CFBamXMsgRspnNmTokenColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokenColCreated" );
