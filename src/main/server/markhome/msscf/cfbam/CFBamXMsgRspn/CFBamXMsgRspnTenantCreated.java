...
// Description: Java 11 XML Message SAX Response Record Element  for Tenant
...
/*
 *	CFBamXMsgRspnTenantCreated XML SAX Element  implementation
 *	for Tenant.
 */
public class CFBamXMsgRspnTenantCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTenantCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTenantCreated" );
			...
			ICFBamTenantObj obj = (ICFBamTenantObj)schemaObj.getTenantTableObj().newInstance();
			CFSecTenantBuff dataBuff = obj.getTenantBuff();
			...
			obj.copyBuffToPKey();
			ICFBamTenantObj realised = (ICFBamTenantObj)obj.realise();
