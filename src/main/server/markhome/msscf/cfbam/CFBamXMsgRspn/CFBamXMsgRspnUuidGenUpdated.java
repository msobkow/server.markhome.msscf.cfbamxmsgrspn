...
/*
 *	CFBamXMsgRspnUuidGenUpdated XML SAX Element  implementation
 *	for UuidGen.
 */
public class CFBamXMsgRspnUuidGenUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidGenUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidGenUpdated" );
