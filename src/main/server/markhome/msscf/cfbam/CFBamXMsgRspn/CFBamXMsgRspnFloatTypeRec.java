...
// Description: Java 11 XML Message SAX Response Record Element  for FloatType
...
/*
 *	CFBamXMsgRspnFloatTypeRec XML SAX Element  implementation
 *	for FloatType.
 */
public class CFBamXMsgRspnFloatTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamFloatTypeBuff dataBuff = obj.getFloatTypeBuff();
