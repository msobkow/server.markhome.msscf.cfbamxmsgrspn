...
/*
 *	CFBamXMsgRspnHostNodeReadSingle XML SAX Element  implementation
 *	for HostNode.
 */
public class CFBamXMsgRspnHostNodeReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnHostNodeReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnHostNodeReadSingle" );
