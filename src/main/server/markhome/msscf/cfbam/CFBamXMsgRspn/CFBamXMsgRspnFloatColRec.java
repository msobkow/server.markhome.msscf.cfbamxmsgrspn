...
// Description: Java 11 XML Message SAX Response Record Element  for FloatCol
...
/*
 *	CFBamXMsgRspnFloatColRec XML SAX Element  implementation
 *	for FloatCol.
 */
public class CFBamXMsgRspnFloatColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamFloatColBuff dataBuff = obj.getFloatColBuff();
