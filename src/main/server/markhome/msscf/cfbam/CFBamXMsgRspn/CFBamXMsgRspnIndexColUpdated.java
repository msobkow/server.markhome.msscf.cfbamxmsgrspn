...
/*
 *	CFBamXMsgRspnIndexColUpdated XML SAX Element  implementation
 *	for IndexCol.
 */
public class CFBamXMsgRspnIndexColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnIndexColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnIndexColUpdated" );
