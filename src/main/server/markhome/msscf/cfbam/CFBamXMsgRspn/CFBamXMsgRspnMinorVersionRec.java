...
/*
 *	CFBamXMsgRspnMinorVersionRec XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFBamXMsgRspnMinorVersionRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnMinorVersionRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFIntMinorVersionObj> list =
				(List<ICFIntMinorVersionObj>)xmsgRspn.getListOfObjects();
