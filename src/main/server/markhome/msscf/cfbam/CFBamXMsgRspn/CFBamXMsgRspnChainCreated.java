...
/*
 *	CFBamXMsgRspnChainCreated XML SAX Element  implementation
 *	for Chain.
 */
public class CFBamXMsgRspnChainCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnChainCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnChainCreated" );
