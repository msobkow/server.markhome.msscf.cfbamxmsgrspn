...
/*
 *	CFBamXMsgRspnSecSessionReadList XML SAX Element  implementation
 *	for SecSession.
 */
public class CFBamXMsgRspnSecSessionReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecSessionReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecSessionReadList" );
			...
			List<ICFSecSecSessionObj> sortedList =
				new ArrayList<ICFSecSecSessionObj>();
