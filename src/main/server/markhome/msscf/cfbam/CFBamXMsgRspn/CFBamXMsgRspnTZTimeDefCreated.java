...
/*
 *	CFBamXMsgRspnTZTimeDefCreated XML SAX Element  implementation
 *	for TZTimeDef.
 */
public class CFBamXMsgRspnTZTimeDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimeDefCreated" );
