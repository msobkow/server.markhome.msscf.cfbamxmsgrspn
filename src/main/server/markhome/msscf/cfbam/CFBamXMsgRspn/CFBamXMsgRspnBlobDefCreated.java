...
/*
 *	CFBamXMsgRspnBlobDefCreated XML SAX Element  implementation
 *	for BlobDef.
 */
public class CFBamXMsgRspnBlobDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobDefCreated" );
