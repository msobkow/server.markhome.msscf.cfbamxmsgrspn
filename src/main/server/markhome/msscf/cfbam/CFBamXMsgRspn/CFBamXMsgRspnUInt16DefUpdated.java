...
/*
 *	CFBamXMsgRspnUInt16DefUpdated XML SAX Element  implementation
 *	for UInt16Def.
 */
public class CFBamXMsgRspnUInt16DefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16DefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt16DefUpdated" );
