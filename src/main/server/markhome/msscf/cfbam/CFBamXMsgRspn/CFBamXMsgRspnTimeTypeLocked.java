...
/*
 *	CFBamXMsgRspnTimeTypeLocked XML SAX Element  implementation
 *	for TimeType.
 */
public class CFBamXMsgRspnTimeTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimeTypeLocked" );
