...
/*
 *	CFBamXMsgRspnTimeColCreated XML SAX Element  implementation
 *	for TimeCol.
 */
public class CFBamXMsgRspnTimeColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimeColCreated" );
