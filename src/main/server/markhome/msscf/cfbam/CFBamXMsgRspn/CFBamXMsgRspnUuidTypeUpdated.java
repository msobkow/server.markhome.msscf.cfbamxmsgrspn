...
/*
 *	CFBamXMsgRspnUuidTypeUpdated XML SAX Element  implementation
 *	for UuidType.
 */
public class CFBamXMsgRspnUuidTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidTypeUpdated" );
