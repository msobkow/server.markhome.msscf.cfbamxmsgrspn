...
// Description: Java 11 XML Message SAX Response Record Element  for TimestampDef
...
/*
 *	CFBamXMsgRspnTimestampDefRec XML SAX Element  implementation
 *	for TimestampDef.
 */
public class CFBamXMsgRspnTimestampDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "TimestampDef" );
			...
			ICFBamTimestampDefObj obj = (ICFBamTimestampDefObj)(schemaObj.getTimestampDefTableObj().newInstance());
			CFBamTimestampDefBuff dataBuff = obj.getTimestampDefBuff();
