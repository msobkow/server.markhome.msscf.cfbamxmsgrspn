...
/*
 *	CFBamXMsgRspnMimeTypeRec XML SAX Element  implementation
 *	for MimeType.
 */
public class CFBamXMsgRspnMimeTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnMimeTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFIntMimeTypeObj> list =
				(List<ICFIntMimeTypeObj>)xmsgRspn.getListOfObjects();
