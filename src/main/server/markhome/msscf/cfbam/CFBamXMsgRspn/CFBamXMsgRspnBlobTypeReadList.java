...
/*
 *	CFBamXMsgRspnBlobTypeReadList XML SAX Element  implementation
 *	for BlobType.
 */
public class CFBamXMsgRspnBlobTypeReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobTypeReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobTypeReadList" );
