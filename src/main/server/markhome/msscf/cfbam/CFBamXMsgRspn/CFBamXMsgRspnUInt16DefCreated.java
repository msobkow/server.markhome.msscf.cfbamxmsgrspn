...
/*
 *	CFBamXMsgRspnUInt16DefCreated XML SAX Element  implementation
 *	for UInt16Def.
 */
public class CFBamXMsgRspnUInt16DefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16DefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt16DefCreated" );
