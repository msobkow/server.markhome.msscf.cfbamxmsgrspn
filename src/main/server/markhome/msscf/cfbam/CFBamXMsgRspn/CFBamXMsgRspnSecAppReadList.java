...
/*
 *	CFBamXMsgRspnSecAppReadList XML SAX Element  implementation
 *	for SecApp.
 */
public class CFBamXMsgRspnSecAppReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecAppReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecAppReadList" );
