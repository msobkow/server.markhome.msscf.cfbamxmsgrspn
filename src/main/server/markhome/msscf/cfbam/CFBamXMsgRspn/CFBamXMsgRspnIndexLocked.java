...
/*
 *	CFBamXMsgRspnIndexLocked XML SAX Element  implementation
 *	for Index.
 */
public class CFBamXMsgRspnIndexLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnIndexLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnIndexLocked" );
