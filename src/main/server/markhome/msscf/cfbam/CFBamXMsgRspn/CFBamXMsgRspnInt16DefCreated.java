...
/*
 *	CFBamXMsgRspnInt16DefCreated XML SAX Element  implementation
 *	for Int16Def.
 */
public class CFBamXMsgRspnInt16DefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16DefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt16DefCreated" );
