...
/*
 *	CFBamXMsgRspnISOCtryLangRec XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFBamXMsgRspnISOCtryLangRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryLangRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecISOCtryLangObj> list =
				(List<ICFSecISOCtryLangObj>)xmsgRspn.getListOfObjects();
