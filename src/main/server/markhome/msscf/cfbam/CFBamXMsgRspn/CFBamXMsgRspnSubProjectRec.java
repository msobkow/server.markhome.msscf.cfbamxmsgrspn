...
/*
 *	CFBamXMsgRspnSubProjectRec XML SAX Element  implementation
 *	for SubProject.
 */
public class CFBamXMsgRspnSubProjectRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSubProjectRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFIntSubProjectObj> list =
				(List<ICFIntSubProjectObj>)xmsgRspn.getListOfObjects();
