...
// Description: Java 11 XML Message SAX Response Record Element  for ServerMethod
...
/*
 *	CFBamXMsgRspnServerMethodRec XML SAX Element  implementation
 *	for ServerMethod.
 */
public class CFBamXMsgRspnServerMethodRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerMethodRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamServerMethodBuff dataBuff = obj.getServerMethodBuff();
