...
/*
 *	CFBamXMsgRspnTSecGrpIncCreated XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFBamXMsgRspnTSecGrpIncCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGrpIncCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGrpIncCreated" );
