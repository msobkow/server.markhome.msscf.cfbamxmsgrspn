...
/*
 *	CFBamXMsgRspnSysClusterRec XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFBamXMsgRspnSysClusterRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSysClusterRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
