...
/*
 *	CFBamXMsgRspnTimestampDefLocked XML SAX Element  implementation
 *	for TimestampDef.
 */
public class CFBamXMsgRspnTimestampDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimestampDefLocked" );
