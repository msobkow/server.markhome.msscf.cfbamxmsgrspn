...
/*
 *	CFBamXMsgRspnId16GenCreated XML SAX Element  implementation
 *	for Id16Gen.
 */
public class CFBamXMsgRspnId16GenCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnId16GenCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnId16GenCreated" );
