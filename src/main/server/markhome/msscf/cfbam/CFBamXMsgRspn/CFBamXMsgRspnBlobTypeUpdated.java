...
/*
 *	CFBamXMsgRspnBlobTypeUpdated XML SAX Element  implementation
 *	for BlobType.
 */
public class CFBamXMsgRspnBlobTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobTypeUpdated" );
