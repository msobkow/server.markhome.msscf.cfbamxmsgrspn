...
// Description: Java 11 XML Message SAX Response Record Element  for TSecGrpMemb
...
/*
 *	CFBamXMsgRspnTSecGrpMembCreated XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFBamXMsgRspnTSecGrpMembCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGrpMembCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGrpMembCreated" );
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "TSecGrpMembId" ) ) {
					if( attrTSecGrpMembId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrTSecGrpMembId = attrs.getValue( idxAttr );
				}
			...
			if( ( attrTSecGrpMembId == null ) || ( attrTSecGrpMembId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"TSecGrpMembId" );
			...
			long natTSecGrpMembId = Long.parseLong( attrTSecGrpMembId );
			...
			ICFBamTSecGrpMembObj obj = (ICFBamTSecGrpMembObj)schemaObj.getTSecGrpMembTableObj().newInstance();
			CFSecTSecGrpMembBuff dataBuff = obj.getTSecGrpMembBuff();
			dataBuff.setRequiredTenantId( natTenantId );
			dataBuff.setRequiredTSecGrpMembId( natTSecGrpMembId );
			...
			obj.copyBuffToPKey();
			ICFBamTSecGrpMembObj realised = (ICFBamTSecGrpMembObj)obj.realise();
