...
/*
 *	CFBamXMsgRspnParamUpdated XML SAX Element  implementation
 *	for Param.
 */
public class CFBamXMsgRspnParamUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnParamUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnParamUpdated" );
