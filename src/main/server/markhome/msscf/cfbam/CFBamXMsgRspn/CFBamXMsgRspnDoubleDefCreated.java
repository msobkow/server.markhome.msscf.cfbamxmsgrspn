...
/*
 *	CFBamXMsgRspnDoubleDefCreated XML SAX Element  implementation
 *	for DoubleDef.
 */
public class CFBamXMsgRspnDoubleDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDoubleDefCreated" );
