...
// Description: Java 11 XML Message SAX Response Record Element  for UuidDef
...
/*
 *	CFBamXMsgRspnUuidDefRec XML SAX Element  implementation
 *	for UuidDef.
 */
public class CFBamXMsgRspnUuidDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuidDefObj obj = (ICFBamUuidDefObj)(schemaObj.getUuidDefTableObj().newInstance());
			CFBamUuidDefBuff dataBuff = obj.getUuidDefBuff();
