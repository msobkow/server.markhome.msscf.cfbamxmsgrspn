...
// Description: Java 11 XML Message SAX Response Record Element  for TZTimestampCol
...
/*
 *	CFBamXMsgRspnTZTimestampColUpdated XML SAX Element  implementation
 *	for TZTimestampCol.
 */
public class CFBamXMsgRspnTZTimestampColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimestampColUpdated" );
			...
			CFBamTZTimestampColBuff dataBuff = obj.getTZTimestampColBuff();
