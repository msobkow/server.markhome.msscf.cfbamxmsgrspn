...
// Description: Java 11 XML Message SAX Response Record Element  for StringType
...
/*
 *	CFBamXMsgRspnStringTypeRec XML SAX Element  implementation
 *	for StringType.
 */
public class CFBamXMsgRspnStringTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "StringType" );
			...
			CFBamStringTypeBuff dataBuff = obj.getStringTypeBuff();
