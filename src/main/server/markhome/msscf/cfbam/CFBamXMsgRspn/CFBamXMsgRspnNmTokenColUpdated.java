...
/*
 *	CFBamXMsgRspnNmTokenColUpdated XML SAX Element  implementation
 *	for NmTokenCol.
 */
public class CFBamXMsgRspnNmTokenColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokenColUpdated" );
