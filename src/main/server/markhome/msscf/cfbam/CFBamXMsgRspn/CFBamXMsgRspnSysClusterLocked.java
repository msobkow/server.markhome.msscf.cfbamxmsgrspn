...
/*
 *	CFBamXMsgRspnSysClusterLocked XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFBamXMsgRspnSysClusterLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSysClusterLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSysClusterLocked" );
