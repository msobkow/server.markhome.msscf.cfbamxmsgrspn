...
/*
 *	CFBamXMsgRspnFloatColCreated XML SAX Element  implementation
 *	for FloatCol.
 */
public class CFBamXMsgRspnFloatColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnFloatColCreated" );
