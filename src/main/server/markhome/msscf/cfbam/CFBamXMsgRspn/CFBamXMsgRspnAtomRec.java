...
/*
 *	CFBamXMsgRspnAtomRec XML SAX Element  implementation
 *	for Atom.
 */
public class CFBamXMsgRspnAtomRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnAtomRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
