...
/*
 *	CFBamXMsgRspnEnumTagUpdated XML SAX Element  implementation
 *	for EnumTag.
 */
public class CFBamXMsgRspnEnumTagUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumTagUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnEnumTagUpdated" );
