...
/*
 *	CFBamXMsgRspnMinorVersionCreated XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFBamXMsgRspnMinorVersionCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnMinorVersionCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
