...
/*
 *	CFBamXMsgRspnISOLangReadSingle XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFBamXMsgRspnISOLangReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOLangReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOLangReadSingle" );
