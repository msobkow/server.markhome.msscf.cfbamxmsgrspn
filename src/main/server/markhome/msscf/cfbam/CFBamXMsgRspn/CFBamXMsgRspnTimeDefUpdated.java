...
/*
 *	CFBamXMsgRspnTimeDefUpdated XML SAX Element  implementation
 *	for TimeDef.
 */
public class CFBamXMsgRspnTimeDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimeDefUpdated" );
