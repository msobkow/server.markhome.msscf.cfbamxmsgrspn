...
/*
 *	CFBamXMsgRspnTopProjectCreated XML SAX Element  implementation
 *	for TopProject.
 */
public class CFBamXMsgRspnTopProjectCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTopProjectCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTopProjectCreated" );
