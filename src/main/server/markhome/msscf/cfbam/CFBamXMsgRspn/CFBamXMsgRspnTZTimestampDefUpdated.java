...
/*
 *	CFBamXMsgRspnTZTimestampDefUpdated XML SAX Element  implementation
 *	for TZTimestampDef.
 */
public class CFBamXMsgRspnTZTimestampDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimestampDefUpdated" );
