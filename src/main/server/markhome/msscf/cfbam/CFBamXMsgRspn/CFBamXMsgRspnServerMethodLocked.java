...
/*
 *	CFBamXMsgRspnServerMethodLocked XML SAX Element  implementation
 *	for ServerMethod.
 */
public class CFBamXMsgRspnServerMethodLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerMethodLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerMethodLocked" );
