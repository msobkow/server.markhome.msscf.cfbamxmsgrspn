...
/*
 *	CFBamXMsgRspnSecUserReadList XML SAX Element  implementation
 *	for SecUser.
 */
public class CFBamXMsgRspnSecUserReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecUserReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecUserReadList" );
			...
			List<ICFSecSecUserObj> sortedList =
				new ArrayList<ICFSecSecUserObj>();
