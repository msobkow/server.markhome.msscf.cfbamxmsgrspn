...
/*
 *	CFBamXMsgRspnUInt64TypeLocked XML SAX Element  implementation
 *	for UInt64Type.
 */
public class CFBamXMsgRspnUInt64TypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64TypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt64TypeLocked" );
