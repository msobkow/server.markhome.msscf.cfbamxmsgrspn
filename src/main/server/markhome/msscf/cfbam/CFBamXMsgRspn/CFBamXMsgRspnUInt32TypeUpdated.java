...
/*
 *	CFBamXMsgRspnUInt32TypeUpdated XML SAX Element  implementation
 *	for UInt32Type.
 */
public class CFBamXMsgRspnUInt32TypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32TypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt32TypeUpdated" );
