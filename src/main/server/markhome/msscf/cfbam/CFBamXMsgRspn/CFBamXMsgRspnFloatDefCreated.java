...
/*
 *	CFBamXMsgRspnFloatDefCreated XML SAX Element  implementation
 *	for FloatDef.
 */
public class CFBamXMsgRspnFloatDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnFloatDefCreated" );
