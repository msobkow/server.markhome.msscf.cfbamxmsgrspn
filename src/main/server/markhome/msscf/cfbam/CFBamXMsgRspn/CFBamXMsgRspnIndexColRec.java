...
// Description: Java 11 XML Message SAX Response Record Element  for IndexCol
...
/*
 *	CFBamXMsgRspnIndexColRec XML SAX Element  implementation
 *	for IndexCol.
 */
public class CFBamXMsgRspnIndexColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnIndexColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamIndexColBuff dataBuff = obj.getIndexColBuff();
			...
			List<ICFBamIndexColObj> list =
				(List<ICFBamIndexColObj>)xmsgRspn.getListOfObjects();
