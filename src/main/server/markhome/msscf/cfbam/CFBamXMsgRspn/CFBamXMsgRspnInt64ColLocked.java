...
/*
 *	CFBamXMsgRspnInt64ColLocked XML SAX Element  implementation
 *	for Int64Col.
 */
public class CFBamXMsgRspnInt64ColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt64ColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt64ColLocked" );
