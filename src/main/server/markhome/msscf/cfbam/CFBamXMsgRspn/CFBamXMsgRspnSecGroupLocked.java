...
/*
 *	CFBamXMsgRspnSecGroupLocked XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFBamXMsgRspnSecGroupLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGroupLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecGroupLocked" );
