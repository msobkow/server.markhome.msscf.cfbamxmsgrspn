...
// Description: Java 11 XML Message SAX Response Record Element  for PopSubDep2
...
/*
 *	CFBamXMsgRspnPopSubDep2Rec XML SAX Element  implementation
 *	for PopSubDep2.
 */
public class CFBamXMsgRspnPopSubDep2Rec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep2Rec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			// PopSubDep2 Attributes
			String	attrPopSubDep1TenantId = null;
			String	attrPopSubDep1Id = null;
			...
			assert qName.equals( "PopSubDep2" );
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "PopSubDep1TenantId" ) ) {
					if( attrPopSubDep1TenantId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrPopSubDep1TenantId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "PopSubDep1Id" ) ) {
					if( attrPopSubDep1Id != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrPopSubDep1Id = attrs.getValue( idxAttr );
				}
			...
			if( ( attrPopSubDep1TenantId == null ) || ( attrPopSubDep1TenantId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"PopSubDep1TenantId" );
			}
			if( ( attrPopSubDep1Id == null ) || ( attrPopSubDep1Id.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"PopSubDep1Id" );
			...
			long natPopSubDep1TenantId = Long.parseLong( attrPopSubDep1TenantId );

			long natPopSubDep1Id = Long.parseLong( attrPopSubDep1Id );
			...
			CFBamPopSubDep2Buff dataBuff = obj.getPopSubDep2Buff();
			...
			dataBuff.setRequiredPopSubDep1TenantId( natPopSubDep1TenantId );
			dataBuff.setRequiredPopSubDep1Id( natPopSubDep1Id );
