...
/*
 *	CFBamXMsgRspnDateColUpdated XML SAX Element  implementation
 *	for DateCol.
 */
public class CFBamXMsgRspnDateColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDateColUpdated" );
