...
/*
 *	CFBamXMsgRspnTimestampTypeLocked XML SAX Element  implementation
 *	for TimestampType.
 */
public class CFBamXMsgRspnTimestampTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimestampTypeLocked" );
