...
/*
 *	CFBamXMsgRspnUuidDefLocked XML SAX Element  implementation
 *	for UuidDef.
 */
public class CFBamXMsgRspnUuidDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidDefLocked" );
