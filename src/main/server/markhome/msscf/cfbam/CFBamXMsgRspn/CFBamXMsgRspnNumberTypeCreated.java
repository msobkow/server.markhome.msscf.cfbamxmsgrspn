...
/*
 *	CFBamXMsgRspnNumberTypeCreated XML SAX Element  implementation
 *	for NumberType.
 */
public class CFBamXMsgRspnNumberTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNumberTypeCreated" );
