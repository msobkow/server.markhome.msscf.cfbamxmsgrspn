...
/*
 *	CFBamXMsgRspnDateTypeCreated XML SAX Element  implementation
 *	for DateType.
 */
public class CFBamXMsgRspnDateTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDateTypeCreated" );
