...
// Description: Java 11 XML Message SAX Response Record Element  for NumberType
...
/*
 *	CFBamXMsgRspnNumberTypeRec XML SAX Element  implementation
 *	for NumberType.
 */
public class CFBamXMsgRspnNumberTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "NumberType" );
			...
			CFBamNumberTypeBuff dataBuff = obj.getNumberTypeBuff();
