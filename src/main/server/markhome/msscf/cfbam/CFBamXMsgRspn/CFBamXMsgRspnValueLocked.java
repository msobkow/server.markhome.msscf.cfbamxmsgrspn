...
/*
 *	CFBamXMsgRspnValueLocked XML SAX Element  implementation
 *	for Value.
 */
public class CFBamXMsgRspnValueLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnValueLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnValueLocked" );
