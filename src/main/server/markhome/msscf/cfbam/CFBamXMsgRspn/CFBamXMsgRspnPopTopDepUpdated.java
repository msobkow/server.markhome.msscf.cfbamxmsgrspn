...
/*
 *	CFBamXMsgRspnPopTopDepUpdated XML SAX Element  implementation
 *	for PopTopDep.
 */
public class CFBamXMsgRspnPopTopDepUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopTopDepUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopTopDepUpdated" );
