...
/*
 *	CFBamXMsgRspnInt32TypeUpdated XML SAX Element  implementation
 *	for Int32Type.
 */
public class CFBamXMsgRspnInt32TypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32TypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt32TypeUpdated" );
