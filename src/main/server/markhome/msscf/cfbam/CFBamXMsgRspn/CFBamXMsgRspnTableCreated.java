...
/*
 *	CFBamXMsgRspnTableCreated XML SAX Element  implementation
 *	for Table.
 */
public class CFBamXMsgRspnTableCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTableCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTableCreated" );
