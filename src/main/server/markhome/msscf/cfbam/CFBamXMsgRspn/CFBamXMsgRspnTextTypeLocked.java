...
/*
 *	CFBamXMsgRspnTextTypeLocked XML SAX Element  implementation
 *	for TextType.
 */
public class CFBamXMsgRspnTextTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTextTypeLocked" );
