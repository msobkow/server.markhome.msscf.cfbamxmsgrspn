...
/*
 *	CFBamXMsgRspnDoubleTypeUpdated XML SAX Element  implementation
 *	for DoubleType.
 */
public class CFBamXMsgRspnDoubleTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDoubleTypeUpdated" );
