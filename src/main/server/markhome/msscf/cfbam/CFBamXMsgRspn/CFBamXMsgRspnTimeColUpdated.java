...
/*
 *	CFBamXMsgRspnTimeColUpdated XML SAX Element  implementation
 *	for TimeCol.
 */
public class CFBamXMsgRspnTimeColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimeColUpdated" );
