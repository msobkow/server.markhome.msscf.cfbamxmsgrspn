...
/*
 *	CFBamXMsgRspnInt32DefLocked XML SAX Element  implementation
 *	for Int32Def.
 */
public class CFBamXMsgRspnInt32DefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32DefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt32DefLocked" );
