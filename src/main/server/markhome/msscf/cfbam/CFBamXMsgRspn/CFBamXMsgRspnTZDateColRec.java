...
// Description: Java 11 XML Message SAX Response Record Element  for TZDateCol
...
/*
 *	CFBamXMsgRspnTZDateColRec XML SAX Element  implementation
 *	for TZDateCol.
 */
public class CFBamXMsgRspnTZDateColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamTZDateColBuff dataBuff = obj.getTZDateColBuff();
