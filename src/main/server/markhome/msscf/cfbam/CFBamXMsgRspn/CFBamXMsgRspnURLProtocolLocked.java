...
/*
 *	CFBamXMsgRspnURLProtocolLocked XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFBamXMsgRspnURLProtocolLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnURLProtocolLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
