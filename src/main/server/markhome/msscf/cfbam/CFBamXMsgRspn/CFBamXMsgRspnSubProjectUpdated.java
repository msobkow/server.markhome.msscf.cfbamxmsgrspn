...
/*
 *	CFBamXMsgRspnSubProjectUpdated XML SAX Element  implementation
 *	for SubProject.
 */
public class CFBamXMsgRspnSubProjectUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSubProjectUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSubProjectUpdated" );
