...
/*
 *	CFBamXMsgRspnStringColLocked XML SAX Element  implementation
 *	for StringCol.
 */
public class CFBamXMsgRspnStringColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnStringColLocked" );
