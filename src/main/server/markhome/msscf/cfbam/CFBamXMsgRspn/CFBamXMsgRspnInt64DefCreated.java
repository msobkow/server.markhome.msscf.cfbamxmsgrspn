...
/*
 *	CFBamXMsgRspnInt64DefCreated XML SAX Element  implementation
 *	for Int64Def.
 */
public class CFBamXMsgRspnInt64DefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt64DefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt64DefCreated" );
