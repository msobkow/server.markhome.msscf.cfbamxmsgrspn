...
// Description: Java 11 XML Message SAX Response Record Element  for BoolType
...
/*
 *	CFBamXMsgRspnBoolTypeRec XML SAX Element  implementation
 *	for BoolType.
 */
public class CFBamXMsgRspnBoolTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamBoolTypeBuff dataBuff = obj.getBoolTypeBuff();
