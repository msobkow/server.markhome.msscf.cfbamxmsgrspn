...
/*
 *	CFBamXMsgRspnISOCtryReadSingle XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFBamXMsgRspnISOCtryReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCtryReadSingle" );
