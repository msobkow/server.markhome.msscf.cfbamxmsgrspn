...
/*
 *	CFBamXMsgRspnSecSessionUpdated XML SAX Element  implementation
 *	for SecSession.
 */
public class CFBamXMsgRspnSecSessionUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecSessionUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
