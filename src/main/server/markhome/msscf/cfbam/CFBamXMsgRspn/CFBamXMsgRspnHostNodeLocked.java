...
/*
 *	CFBamXMsgRspnHostNodeLocked XML SAX Element  implementation
 *	for HostNode.
 */
public class CFBamXMsgRspnHostNodeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnHostNodeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnHostNodeLocked" );
