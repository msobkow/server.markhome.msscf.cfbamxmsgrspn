...
/*
 *	CFBamXMsgRspnEnumTagLocked XML SAX Element  implementation
 *	for EnumTag.
 */
public class CFBamXMsgRspnEnumTagLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumTagLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnEnumTagLocked" );
