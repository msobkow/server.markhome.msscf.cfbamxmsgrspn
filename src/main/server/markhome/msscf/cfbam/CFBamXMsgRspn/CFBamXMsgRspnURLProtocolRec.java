...
/*
 *	CFBamXMsgRspnURLProtocolRec XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFBamXMsgRspnURLProtocolRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnURLProtocolRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFIntURLProtocolObj> list =
				(List<ICFIntURLProtocolObj>)xmsgRspn.getListOfObjects();
