...
/*
 *	CFBamXMsgRspnInt16TypeCreated XML SAX Element  implementation
 *	for Int16Type.
 */
public class CFBamXMsgRspnInt16TypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16TypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt16TypeCreated" );
