...
/*
 *	CFBamXMsgRspnBlobColLocked XML SAX Element  implementation
 *	for BlobCol.
 */
public class CFBamXMsgRspnBlobColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobColLocked" );
