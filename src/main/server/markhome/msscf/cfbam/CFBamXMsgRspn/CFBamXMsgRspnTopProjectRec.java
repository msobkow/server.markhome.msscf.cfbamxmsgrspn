...
/*
 *	CFBamXMsgRspnTopProjectRec XML SAX Element  implementation
 *	for TopProject.
 */
public class CFBamXMsgRspnTopProjectRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTopProjectRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "TopProject" );
			...
			List<ICFIntTopProjectObj> list =
				(List<ICFIntTopProjectObj>)xmsgRspn.getListOfObjects();
