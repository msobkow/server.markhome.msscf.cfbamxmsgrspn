...
/*
 *	CFBamXMsgRspnBoolDefLocked XML SAX Element  implementation
 *	for BoolDef.
 */
public class CFBamXMsgRspnBoolDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBoolDefLocked" );
