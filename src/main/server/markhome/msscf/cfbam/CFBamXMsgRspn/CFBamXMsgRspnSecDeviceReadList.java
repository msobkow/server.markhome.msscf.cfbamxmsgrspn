...
/*
 *	CFBamXMsgRspnSecDeviceReadList XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFBamXMsgRspnSecDeviceReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecDeviceReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecDeviceReadList" );
			...
			List<ICFSecSecDeviceObj> sortedList =
				new ArrayList<ICFSecSecDeviceObj>();
