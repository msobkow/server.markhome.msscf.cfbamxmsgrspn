...
/*
 *	CFBamXMsgRspnUuidGenLocked XML SAX Element  implementation
 *	for UuidGen.
 */
public class CFBamXMsgRspnUuidGenLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidGenLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidGenLocked" );
