...
// Description: Java 11 XML Message SAX Response Record Element  for DelTopDep
...
/*
 *	CFBamXMsgRspnDelTopDepRec XML SAX Element  implementation
 *	for DelTopDep.
 */
public class CFBamXMsgRspnDelTopDepRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelTopDepRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamDelTopDepBuff dataBuff = obj.getDelTopDepBuff();
