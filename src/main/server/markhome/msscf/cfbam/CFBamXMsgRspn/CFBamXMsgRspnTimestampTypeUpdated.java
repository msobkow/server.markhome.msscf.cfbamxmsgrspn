...
/*
 *	CFBamXMsgRspnTimestampTypeUpdated XML SAX Element  implementation
 *	for TimestampType.
 */
public class CFBamXMsgRspnTimestampTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimestampTypeUpdated" );
