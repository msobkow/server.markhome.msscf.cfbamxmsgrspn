...
/*
 *	CFBamXMsgRspnTableColUpdated XML SAX Element  implementation
 *	for TableCol.
 */
public class CFBamXMsgRspnTableColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTableColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTableColUpdated" );
