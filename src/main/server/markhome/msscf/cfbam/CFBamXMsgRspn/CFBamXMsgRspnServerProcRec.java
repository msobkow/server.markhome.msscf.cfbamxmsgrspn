...
// Description: Java 11 XML Message SAX Response Record Element  for ServerProc
...
/*
 *	CFBamXMsgRspnServerProcRec XML SAX Element  implementation
 *	for ServerProc.
 */
public class CFBamXMsgRspnServerProcRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerProcRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamServerProcBuff dataBuff = obj.getServerProcBuff();
