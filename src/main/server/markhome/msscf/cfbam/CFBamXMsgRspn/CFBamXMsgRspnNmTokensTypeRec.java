...
// Description: Java 11 XML Message SAX Response Record Element  for NmTokensType
...
/*
 *	CFBamXMsgRspnNmTokensTypeRec XML SAX Element  implementation
 *	for NmTokensType.
 */
public class CFBamXMsgRspnNmTokensTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "NmTokensType" );
			...
			CFBamNmTokensTypeBuff dataBuff = obj.getNmTokensTypeBuff();
