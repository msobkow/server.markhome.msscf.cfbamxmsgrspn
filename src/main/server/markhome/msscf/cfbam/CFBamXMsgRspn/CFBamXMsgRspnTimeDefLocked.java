...
/*
 *	CFBamXMsgRspnTimeDefLocked XML SAX Element  implementation
 *	for TimeDef.
 */
public class CFBamXMsgRspnTimeDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimeDefLocked" );
