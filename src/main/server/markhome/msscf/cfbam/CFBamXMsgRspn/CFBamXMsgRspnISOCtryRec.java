...
/*
 *	CFBamXMsgRspnISOCtryRec XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFBamXMsgRspnISOCtryRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecISOCtryObj> list =
				(List<ICFSecISOCtryObj>)xmsgRspn.getListOfObjects();
