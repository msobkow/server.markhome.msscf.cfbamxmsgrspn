...
/*
 *	CFBamXMsgRspnClearSubDep1Updated XML SAX Element  implementation
 *	for ClearSubDep1.
 */
public class CFBamXMsgRspnClearSubDep1Updated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep1Updated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearSubDep1Updated" );
