...
// Description: Java 11 XML Message SAX Response Record Element  for Int32Def
...
/*
 *	CFBamXMsgRspnInt32DefRec XML SAX Element  implementation
 *	for Int32Def.
 */
public class CFBamXMsgRspnInt32DefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32DefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt32DefObj obj = (ICFBamInt32DefObj)(schemaObj.getInt32DefTableObj().newInstance());
			CFBamInt32DefBuff dataBuff = obj.getInt32DefBuff();
