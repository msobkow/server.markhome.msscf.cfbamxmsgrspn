...
/*
 *	CFBamXMsgRspnServerMethodCreated XML SAX Element  implementation
 *	for ServerMethod.
 */
public class CFBamXMsgRspnServerMethodCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerMethodCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerMethodCreated" );
