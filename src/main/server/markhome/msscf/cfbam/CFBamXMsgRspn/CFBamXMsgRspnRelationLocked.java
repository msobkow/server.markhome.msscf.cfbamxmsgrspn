...
/*
 *	CFBamXMsgRspnRelationLocked XML SAX Element  implementation
 *	for Relation.
 */
public class CFBamXMsgRspnRelationLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnRelationLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnRelationLocked" );
