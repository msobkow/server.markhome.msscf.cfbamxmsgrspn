...
/*
 *	CFBamXMsgRspnTableDeleted XML SAX Element  implementation
 *	for Table.
 */
public class CFBamXMsgRspnTableDeleted
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTableDeleted( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTableDeleted" );
