...
/*
 *	CFBamXMsgRspnParamCreated XML SAX Element  implementation
 *	for Param.
 */
public class CFBamXMsgRspnParamCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnParamCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnParamCreated" );
