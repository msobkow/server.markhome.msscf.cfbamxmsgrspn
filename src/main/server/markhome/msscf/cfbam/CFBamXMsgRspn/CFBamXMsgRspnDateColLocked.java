...
/*
 *	CFBamXMsgRspnDateColLocked XML SAX Element  implementation
 *	for DateCol.
 */
public class CFBamXMsgRspnDateColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDateColLocked" );
