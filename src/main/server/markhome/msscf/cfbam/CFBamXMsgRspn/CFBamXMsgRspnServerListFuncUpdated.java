...
/*
 *	CFBamXMsgRspnServerListFuncUpdated XML SAX Element  implementation
 *	for ServerListFunc.
 */
public class CFBamXMsgRspnServerListFuncUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerListFuncUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerListFuncUpdated" );
