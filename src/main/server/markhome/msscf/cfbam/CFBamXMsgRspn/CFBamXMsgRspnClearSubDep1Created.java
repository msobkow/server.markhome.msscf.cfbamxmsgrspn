...
/*
 *	CFBamXMsgRspnClearSubDep1Created XML SAX Element  implementation
 *	for ClearSubDep1.
 */
public class CFBamXMsgRspnClearSubDep1Created
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep1Created( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearSubDep1Created" );
