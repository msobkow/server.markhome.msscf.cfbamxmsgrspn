...
/*
 *	CFBamXMsgRspnDoubleDefLocked XML SAX Element  implementation
 *	for DoubleDef.
 */
public class CFBamXMsgRspnDoubleDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDoubleDefLocked" );
