...
/*
 *	CFBamXMsgRspnSecAppUpdated XML SAX Element  implementation
 *	for SecApp.
 */
public class CFBamXMsgRspnSecAppUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecAppUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecAppUpdated" );
			...
			ICFBamSecAppObj obj = (ICFBamSecAppObj)schemaObj.getSecAppTableObj().newInstance();
			CFSecSecAppBuff dataBuff = obj.getSecAppBuff();
			...
			obj.copyBuffToPKey();
			ICFBamSecAppObj realised = (ICFBamSecAppObj)obj.realise();
