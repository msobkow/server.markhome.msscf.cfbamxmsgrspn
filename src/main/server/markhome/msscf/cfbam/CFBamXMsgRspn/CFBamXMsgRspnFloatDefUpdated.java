...
/*
 *	CFBamXMsgRspnFloatDefUpdated XML SAX Element  implementation
 *	for FloatDef.
 */
public class CFBamXMsgRspnFloatDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnFloatDefUpdated" );
