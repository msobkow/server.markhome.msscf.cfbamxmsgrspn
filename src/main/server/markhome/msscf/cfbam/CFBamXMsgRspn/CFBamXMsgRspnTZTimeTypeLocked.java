...
/*
 *	CFBamXMsgRspnTZTimeTypeLocked XML SAX Element  implementation
 *	for TZTimeType.
 */
public class CFBamXMsgRspnTZTimeTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimeTypeLocked" );
