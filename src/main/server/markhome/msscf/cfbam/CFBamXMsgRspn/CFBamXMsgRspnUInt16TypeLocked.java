...
/*
 *	CFBamXMsgRspnUInt16TypeLocked XML SAX Element  implementation
 *	for UInt16Type.
 */
public class CFBamXMsgRspnUInt16TypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16TypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt16TypeLocked" );
