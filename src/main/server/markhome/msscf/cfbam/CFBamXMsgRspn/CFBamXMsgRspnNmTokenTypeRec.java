...
// Description: Java 11 XML Message SAX Response Record Element  for NmTokenType
...
/*
 *	CFBamXMsgRspnNmTokenTypeRec XML SAX Element  implementation
 *	for NmTokenType.
 */
public class CFBamXMsgRspnNmTokenTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "NmTokenType" );
			...
			CFBamNmTokenTypeBuff dataBuff = obj.getNmTokenTypeBuff();
