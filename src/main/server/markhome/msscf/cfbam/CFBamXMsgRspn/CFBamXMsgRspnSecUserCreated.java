...
/*
 *	CFBamXMsgRspnSecUserCreated XML SAX Element  implementation
 *	for SecUser.
 */
public class CFBamXMsgRspnSecUserCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecUserCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
