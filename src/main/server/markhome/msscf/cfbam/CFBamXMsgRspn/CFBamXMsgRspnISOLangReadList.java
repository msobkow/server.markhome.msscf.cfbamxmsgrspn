...
/*
 *	CFBamXMsgRspnISOLangReadList XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFBamXMsgRspnISOLangReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOLangReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOLangReadList" );
			...
			List<ICFSecISOLangObj> sortedList =
				new ArrayList<ICFSecISOLangObj>();
