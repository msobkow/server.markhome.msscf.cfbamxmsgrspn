...
/*
 *	CFBamXMsgRspnTimeDefCreated XML SAX Element  implementation
 *	for TimeDef.
 */
public class CFBamXMsgRspnTimeDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimeDefCreated" );
