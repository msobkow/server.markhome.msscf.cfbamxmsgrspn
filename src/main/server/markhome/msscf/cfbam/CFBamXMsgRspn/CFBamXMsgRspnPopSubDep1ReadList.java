...
/*
 *	CFBamXMsgRspnPopSubDep1ReadList XML SAX Element  implementation
 *	for PopSubDep1.
 */
public class CFBamXMsgRspnPopSubDep1ReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep1ReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopSubDep1ReadList" );
