...
/*
 *	CFBamXMsgRspnChainUpdated XML SAX Element  implementation
 *	for Chain.
 */
public class CFBamXMsgRspnChainUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnChainUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnChainUpdated" );
