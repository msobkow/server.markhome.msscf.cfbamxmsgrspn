...
/*
 *	CFBamXMsgRspnTZDateColCreated XML SAX Element  implementation
 *	for TZDateCol.
 */
public class CFBamXMsgRspnTZDateColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZDateColCreated" );
