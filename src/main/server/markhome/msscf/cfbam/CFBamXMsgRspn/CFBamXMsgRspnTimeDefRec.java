...
// Description: Java 11 XML Message SAX Response Record Element  for TimeDef
...
/*
 *	CFBamXMsgRspnTimeDefRec XML SAX Element  implementation
 *	for TimeDef.
 */
public class CFBamXMsgRspnTimeDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimeDefObj obj = (ICFBamTimeDefObj)(schemaObj.getTimeDefTableObj().newInstance());
			CFBamTimeDefBuff dataBuff = obj.getTimeDefBuff();
