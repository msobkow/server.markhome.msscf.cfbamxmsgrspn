...
// Description: Java 11 XML Message SAX Response Record Element  for UInt32Type
...
/*
 *	CFBamXMsgRspnUInt32TypeCreated XML SAX Element  implementation
 *	for UInt32Type.
 */
public class CFBamXMsgRspnUInt32TypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32TypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt32TypeCreated" );
			...
			CFBamUInt32TypeBuff dataBuff = obj.getUInt32TypeBuff();
