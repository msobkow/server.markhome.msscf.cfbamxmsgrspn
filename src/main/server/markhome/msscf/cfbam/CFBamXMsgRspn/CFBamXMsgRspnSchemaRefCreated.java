...
/*
 *	CFBamXMsgRspnSchemaRefCreated XML SAX Element  implementation
 *	for SchemaRef.
 */
public class CFBamXMsgRspnSchemaRefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSchemaRefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSchemaRefCreated" );
