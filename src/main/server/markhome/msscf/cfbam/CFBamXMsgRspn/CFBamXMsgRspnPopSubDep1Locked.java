...
/*
 *	CFBamXMsgRspnPopSubDep1Locked XML SAX Element  implementation
 *	for PopSubDep1.
 */
public class CFBamXMsgRspnPopSubDep1Locked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep1Locked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopSubDep1Locked" );
