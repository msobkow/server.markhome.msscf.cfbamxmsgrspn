...
/*
 *	CFBamXMsgRspnInt32DefCreated XML SAX Element  implementation
 *	for Int32Def.
 */
public class CFBamXMsgRspnInt32DefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32DefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt32DefCreated" );
