...
/*
 *	CFBamXMsgRspnId32GenUpdated XML SAX Element  implementation
 *	for Id32Gen.
 */
public class CFBamXMsgRspnId32GenUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnId32GenUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnId32GenUpdated" );
