...
/*
 *	CFBamXMsgRspnSecGroupFormReadList XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFBamXMsgRspnSecGroupFormReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGroupFormReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecGroupFormReadList" );
			...
			List<ICFSecSecGroupFormObj> sortedList =
				new ArrayList<ICFSecSecGroupFormObj>();
