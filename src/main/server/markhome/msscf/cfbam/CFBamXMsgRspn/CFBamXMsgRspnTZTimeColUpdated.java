...
/*
 *	CFBamXMsgRspnTZTimeColUpdated XML SAX Element  implementation
 *	for TZTimeCol.
 */
public class CFBamXMsgRspnTZTimeColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimeColUpdated" );
