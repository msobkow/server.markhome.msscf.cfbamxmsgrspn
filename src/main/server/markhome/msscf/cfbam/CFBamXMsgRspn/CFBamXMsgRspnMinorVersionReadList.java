...
/*
 *	CFBamXMsgRspnMinorVersionReadList XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFBamXMsgRspnMinorVersionReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnMinorVersionReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnMinorVersionReadList" );
			...
			List<ICFIntMinorVersionObj> sortedList =
				new ArrayList<ICFIntMinorVersionObj>();
