...
/*
 *	CFBamXMsgRspnBoolDefUpdated XML SAX Element  implementation
 *	for BoolDef.
 */
public class CFBamXMsgRspnBoolDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBoolDefUpdated" );
