...
/*
 *	CFBamXMsgRspnIndexReadList XML SAX Element  implementation
 *	for Index.
 */
public class CFBamXMsgRspnIndexReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnIndexReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnIndexReadList" );
