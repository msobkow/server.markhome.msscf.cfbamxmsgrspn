...
/*
 *	CFBamXMsgRspnDelTopDepCreated XML SAX Element  implementation
 *	for DelTopDep.
 */
public class CFBamXMsgRspnDelTopDepCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelTopDepCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelTopDepCreated" );
