...
/*
 *	CFBamXMsgRspnSecUserLocked XML SAX Element  implementation
 *	for SecUser.
 */
public class CFBamXMsgRspnSecUserLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecUserLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecUserLocked" );
