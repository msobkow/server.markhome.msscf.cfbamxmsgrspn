...
/*
 *	CFBamXMsgRspnIndexColLocked XML SAX Element  implementation
 *	for IndexCol.
 */
public class CFBamXMsgRspnIndexColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnIndexColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnIndexColLocked" );
