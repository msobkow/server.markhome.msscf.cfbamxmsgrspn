...
// Description: Java 11 XML Message SAX Response Record Element  for SecGrpInc
...
/*
 *	CFBamXMsgRspnSecGrpIncCreated XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFBamXMsgRspnSecGrpIncCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGrpIncCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecGrpIncCreated" );
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "SecGrpIncId" ) ) {
					if( attrSecGrpIncId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrSecGrpIncId = attrs.getValue( idxAttr );
				}
			...
			if( ( attrSecGrpIncId == null ) || ( attrSecGrpIncId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"SecGrpIncId" );
			...
			long natSecGrpIncId = Long.parseLong( attrSecGrpIncId );
			...
			ICFBamSecGrpIncObj obj = (ICFBamSecGrpIncObj)schemaObj.getSecGrpIncTableObj().newInstance();
			CFSecSecGrpIncBuff dataBuff = obj.getSecGrpIncBuff();
			dataBuff.setRequiredClusterId( natClusterId );
			dataBuff.setRequiredSecGrpIncId( natSecGrpIncId );
			...
			obj.copyBuffToPKey();
			ICFBamSecGrpIncObj realised = (ICFBamSecGrpIncObj)obj.realise();
