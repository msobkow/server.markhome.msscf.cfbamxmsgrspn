...
/*
 *	CFBamXMsgRspnURLProtocolReadList XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFBamXMsgRspnURLProtocolReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnURLProtocolReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnURLProtocolReadList" );
			...
			List<ICFIntURLProtocolObj> sortedList =
				new ArrayList<ICFIntURLProtocolObj>();
