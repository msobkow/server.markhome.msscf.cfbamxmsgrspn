...
/*
 *	CFBamXMsgRspnISOCtryLangUpdated XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFBamXMsgRspnISOCtryLangUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryLangUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCtryLangUpdated" );
