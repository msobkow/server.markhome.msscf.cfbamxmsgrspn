...
/*
 *	CFBamXMsgRspnPopSubDep2Updated XML SAX Element  implementation
 *	for PopSubDep2.
 */
public class CFBamXMsgRspnPopSubDep2Updated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep2Updated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopSubDep2Updated" );
