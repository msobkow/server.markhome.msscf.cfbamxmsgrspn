...
/*
 *	CFBamXMsgRspnISOCtryCcyRec XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFBamXMsgRspnISOCtryCcyRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryCcyRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecISOCtryCcyObj> list =
				(List<ICFSecISOCtryCcyObj>)xmsgRspn.getListOfObjects();
