...
// Description: Java 11 XML Message SAX Response Record Element  for Scope
...
/*
 *	CFBamXMsgRspnScopeRec XML SAX Element  implementation
 *	for Scope.
 */
public class CFBamXMsgRspnScopeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnScopeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamScopeObj obj = (ICFBamScopeObj)(schemaObj.getScopeTableObj().newInstance());
			CFBamScopeBuff dataBuff = obj.getScopeBuff();
