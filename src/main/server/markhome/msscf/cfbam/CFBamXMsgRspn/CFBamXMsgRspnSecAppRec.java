...
/*
 *	CFBamXMsgRspnSecAppRec XML SAX Element  implementation
 *	for SecApp.
 */
public class CFBamXMsgRspnSecAppRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecAppRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecSecAppObj> list =
				(List<ICFSecSecAppObj>)xmsgRspn.getListOfObjects();
