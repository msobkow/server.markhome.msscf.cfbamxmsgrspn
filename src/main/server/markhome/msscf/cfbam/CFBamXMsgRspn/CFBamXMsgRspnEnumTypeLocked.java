...
/*
 *	CFBamXMsgRspnEnumTypeLocked XML SAX Element  implementation
 *	for EnumType.
 */
public class CFBamXMsgRspnEnumTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnEnumTypeLocked" );
