...
/*
 *	CFBamXMsgRspnInt64TypeUpdated XML SAX Element  implementation
 *	for Int64Type.
 */
public class CFBamXMsgRspnInt64TypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt64TypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt64TypeUpdated" );
