...
/*
 *	CFBamXMsgRspnTZDateDefUpdated XML SAX Element  implementation
 *	for TZDateDef.
 */
public class CFBamXMsgRspnTZDateDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZDateDefUpdated" );
