...
/*
 *	CFBamXMsgRspnIndexReadSingle XML SAX Element  implementation
 *	for Index.
 */
public class CFBamXMsgRspnIndexReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnIndexReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnIndexReadSingle" );
