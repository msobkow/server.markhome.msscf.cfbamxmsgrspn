...
/*
 *	CFBamXMsgRspnTSecGroupRec XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFBamXMsgRspnTSecGroupRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGroupRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecTSecGroupObj> list =
				(List<ICFSecTSecGroupObj>)xmsgRspn.getListOfObjects();
