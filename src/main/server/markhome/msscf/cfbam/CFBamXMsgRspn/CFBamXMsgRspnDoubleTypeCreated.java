...
/*
 *	CFBamXMsgRspnDoubleTypeCreated XML SAX Element  implementation
 *	for DoubleType.
 */
public class CFBamXMsgRspnDoubleTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDoubleTypeCreated" );
