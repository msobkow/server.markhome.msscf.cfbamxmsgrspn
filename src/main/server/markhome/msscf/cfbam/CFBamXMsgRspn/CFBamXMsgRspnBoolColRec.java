...
// Description: Java 11 XML Message SAX Response Record Element  for BoolCol
...
/*
 *	CFBamXMsgRspnBoolColRec XML SAX Element  implementation
 *	for BoolCol.
 */
public class CFBamXMsgRspnBoolColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamBoolColBuff dataBuff = obj.getBoolColBuff();
