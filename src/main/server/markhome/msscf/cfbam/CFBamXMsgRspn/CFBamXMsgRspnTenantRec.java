...
/*
 *	CFBamXMsgRspnTenantRec XML SAX Element  implementation
 *	for Tenant.
 */
public class CFBamXMsgRspnTenantRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTenantRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecTenantObj> list =
				(List<ICFSecTenantObj>)xmsgRspn.getListOfObjects();
