...
/*
 *	CFBamXMsgRspnSecDeviceLocked XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFBamXMsgRspnSecDeviceLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecDeviceLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecDeviceLocked" );
