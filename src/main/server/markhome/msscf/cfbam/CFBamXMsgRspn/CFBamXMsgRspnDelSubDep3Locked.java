...
/*
 *	CFBamXMsgRspnDelSubDep3Locked XML SAX Element  implementation
 *	for DelSubDep3.
 */
public class CFBamXMsgRspnDelSubDep3Locked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep3Locked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelSubDep3Locked" );
