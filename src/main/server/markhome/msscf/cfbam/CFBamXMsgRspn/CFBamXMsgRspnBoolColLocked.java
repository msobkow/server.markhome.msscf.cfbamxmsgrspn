...
/*
 *	CFBamXMsgRspnBoolColLocked XML SAX Element  implementation
 *	for BoolCol.
 */
public class CFBamXMsgRspnBoolColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBoolColLocked" );
