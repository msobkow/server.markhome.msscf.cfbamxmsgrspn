...
/*
 *	CFBamXMsgRspnInt64ColUpdated XML SAX Element  implementation
 *	for Int64Col.
 */
public class CFBamXMsgRspnInt64ColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt64ColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt64ColUpdated" );
