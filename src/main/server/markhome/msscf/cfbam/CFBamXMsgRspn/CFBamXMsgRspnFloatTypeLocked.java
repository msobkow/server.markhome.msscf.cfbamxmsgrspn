...
/*
 *	CFBamXMsgRspnFloatTypeLocked XML SAX Element  implementation
 *	for FloatType.
 */
public class CFBamXMsgRspnFloatTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnFloatTypeLocked" );
