...
/*
 *	CFBamXMsgRspnInt32TypeLocked XML SAX Element  implementation
 *	for Int32Type.
 */
public class CFBamXMsgRspnInt32TypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32TypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt32TypeLocked" );
