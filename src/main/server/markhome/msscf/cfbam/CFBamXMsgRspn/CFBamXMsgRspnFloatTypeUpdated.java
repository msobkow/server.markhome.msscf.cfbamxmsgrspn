...
/*
 *	CFBamXMsgRspnFloatTypeUpdated XML SAX Element  implementation
 *	for FloatType.
 */
public class CFBamXMsgRspnFloatTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnFloatTypeUpdated" );
