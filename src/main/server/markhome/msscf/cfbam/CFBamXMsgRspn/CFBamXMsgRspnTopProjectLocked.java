...
/*
 *	CFBamXMsgRspnTopProjectLocked XML SAX Element  implementation
 *	for TopProject.
 */
public class CFBamXMsgRspnTopProjectLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTopProjectLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTopProjectLocked" );
