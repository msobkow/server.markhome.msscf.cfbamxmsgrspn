...
/*
 *	CFBamXMsgRspnClearDepCreated XML SAX Element  implementation
 *	for ClearDep.
 */
public class CFBamXMsgRspnClearDepCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearDepCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearDepCreated" );
