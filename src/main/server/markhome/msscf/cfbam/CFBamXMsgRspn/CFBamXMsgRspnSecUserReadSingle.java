...
/*
 *	CFBamXMsgRspnSecUserReadSingle XML SAX Element  implementation
 *	for SecUser.
 */
public class CFBamXMsgRspnSecUserReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecUserReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecUserReadSingle" );
