...
/*
 *	CFBamXMsgRspnTimeColLocked XML SAX Element  implementation
 *	for TimeCol.
 */
public class CFBamXMsgRspnTimeColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimeColLocked" );
