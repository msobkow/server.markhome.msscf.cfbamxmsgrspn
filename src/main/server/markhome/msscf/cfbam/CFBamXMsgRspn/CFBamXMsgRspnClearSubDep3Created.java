...
/*
 *	CFBamXMsgRspnClearSubDep3Created XML SAX Element  implementation
 *	for ClearSubDep3.
 */
public class CFBamXMsgRspnClearSubDep3Created
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep3Created( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearSubDep3Created" );
