...
/*
 *	CFBamXMsgRspnServerProcCreated XML SAX Element  implementation
 *	for ServerProc.
 */
public class CFBamXMsgRspnServerProcCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerProcCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerProcCreated" );
