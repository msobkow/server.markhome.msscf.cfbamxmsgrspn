...
/*
 *	CFBamXMsgRspnTimestampTypeRec XML SAX Element  implementation
 *	for TimestampType.
 */
public class CFBamXMsgRspnTimestampTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
