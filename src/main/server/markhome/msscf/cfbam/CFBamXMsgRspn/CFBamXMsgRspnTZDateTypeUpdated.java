...
/*
 *	CFBamXMsgRspnTZDateTypeUpdated XML SAX Element  implementation
 *	for TZDateType.
 */
public class CFBamXMsgRspnTZDateTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZDateTypeUpdated" );
