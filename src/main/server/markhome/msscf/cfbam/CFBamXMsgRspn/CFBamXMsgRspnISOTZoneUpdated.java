...
/*
 *	CFBamXMsgRspnISOTZoneUpdated XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFBamXMsgRspnISOTZoneUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOTZoneUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOTZoneUpdated" );
			...
			ICFBamISOTZoneObj obj = (ICFBamISOTZoneObj)schemaObj.getISOTZoneTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFBamISOTZoneObj realised = (ICFBamISOTZoneObj)obj.realise();
