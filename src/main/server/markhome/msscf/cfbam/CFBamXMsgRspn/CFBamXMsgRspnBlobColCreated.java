...
/*
 *	CFBamXMsgRspnBlobColCreated XML SAX Element  implementation
 *	for BlobCol.
 */
public class CFBamXMsgRspnBlobColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBlobColCreated" );
