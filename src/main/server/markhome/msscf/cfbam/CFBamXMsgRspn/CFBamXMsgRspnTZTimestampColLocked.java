...
/*
 *	CFBamXMsgRspnTZTimestampColLocked XML SAX Element  implementation
 *	for TZTimestampCol.
 */
public class CFBamXMsgRspnTZTimestampColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimestampColLocked" );
