...
// Description: Java 11 XML Message SAX Response Record Element  for Int16Def
...
/*
 *	CFBamXMsgRspnInt16DefRec XML SAX Element  implementation
 *	for Int16Def.
 */
public class CFBamXMsgRspnInt16DefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16DefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt16DefObj obj = (ICFBamInt16DefObj)(schemaObj.getInt16DefTableObj().newInstance());
			CFBamInt16DefBuff dataBuff = obj.getInt16DefBuff();
