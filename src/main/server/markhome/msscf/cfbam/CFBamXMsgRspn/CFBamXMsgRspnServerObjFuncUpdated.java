...
/*
 *	CFBamXMsgRspnServerObjFuncUpdated XML SAX Element  implementation
 *	for ServerObjFunc.
 */
public class CFBamXMsgRspnServerObjFuncUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerObjFuncUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerObjFuncUpdated" );
