...
/*
 *	CFBamXMsgRspnUInt32ColCreated XML SAX Element  implementation
 *	for UInt32Col.
 */
public class CFBamXMsgRspnUInt32ColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32ColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt32ColCreated" );
