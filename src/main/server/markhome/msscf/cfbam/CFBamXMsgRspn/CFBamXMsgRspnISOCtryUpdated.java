...
/*
 *	CFBamXMsgRspnISOCtryUpdated XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFBamXMsgRspnISOCtryUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCtryUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCtryUpdated" );
			...
			ICFBamISOCtryObj obj = (ICFBamISOCtryObj)schemaObj.getISOCtryTableObj().newInstance();
			CFSecISOCtryBuff dataBuff = obj.getISOCtryBuff();
			...
			obj.copyBuffToPKey();
			ICFBamISOCtryObj realised = (ICFBamISOCtryObj)obj.realise();
