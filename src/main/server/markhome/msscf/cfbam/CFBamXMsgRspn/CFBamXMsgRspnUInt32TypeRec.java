...
/*
 *	CFBamXMsgRspnUInt32TypeRec XML SAX Element  implementation
 *	for UInt32Type.
 */
public class CFBamXMsgRspnUInt32TypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32TypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
