...
/*
 *	CFBamXMsgRspnIndexDeleted XML SAX Element  implementation
 *	for Index.
 */
public class CFBamXMsgRspnIndexDeleted
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnIndexDeleted( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnIndexDeleted" );
