...
/*
 *	CFBamXMsgRspnUuidDefCreated XML SAX Element  implementation
 *	for UuidDef.
 */
public class CFBamXMsgRspnUuidDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidDefCreated" );
