...
/*
 *	CFBamXMsgRspnIndexUpdated XML SAX Element  implementation
 *	for Index.
 */
public class CFBamXMsgRspnIndexUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnIndexUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnIndexUpdated" );
