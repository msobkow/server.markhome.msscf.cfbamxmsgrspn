...
/*
 *	CFBamXMsgRspnUuidColUpdated XML SAX Element  implementation
 *	for UuidCol.
 */
public class CFBamXMsgRspnUuidColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidColUpdated" );
