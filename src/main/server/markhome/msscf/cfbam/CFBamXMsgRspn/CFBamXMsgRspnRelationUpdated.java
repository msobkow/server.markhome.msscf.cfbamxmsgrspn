...
/*
 *	CFBamXMsgRspnRelationUpdated XML SAX Element  implementation
 *	for Relation.
 */
public class CFBamXMsgRspnRelationUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnRelationUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnRelationUpdated" );
