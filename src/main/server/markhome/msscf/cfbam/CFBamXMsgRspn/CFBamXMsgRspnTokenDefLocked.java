...
/*
 *	CFBamXMsgRspnTokenDefLocked XML SAX Element  implementation
 *	for TokenDef.
 */
public class CFBamXMsgRspnTokenDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTokenDefLocked" );
