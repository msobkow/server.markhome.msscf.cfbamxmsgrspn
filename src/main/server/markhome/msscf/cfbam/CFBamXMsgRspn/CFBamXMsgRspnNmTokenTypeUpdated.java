...
/*
 *	CFBamXMsgRspnNmTokenTypeUpdated XML SAX Element  implementation
 *	for NmTokenType.
 */
public class CFBamXMsgRspnNmTokenTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokenTypeUpdated" );
