...
/*
 *	CFBamXMsgRspnTokenColUpdated XML SAX Element  implementation
 *	for TokenCol.
 */
public class CFBamXMsgRspnTokenColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTokenColUpdated" );
