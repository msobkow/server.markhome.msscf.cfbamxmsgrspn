...
/*
 *	CFBamXMsgRspnTZDateColUpdated XML SAX Element  implementation
 *	for TZDateCol.
 */
public class CFBamXMsgRspnTZDateColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZDateColUpdated" );
