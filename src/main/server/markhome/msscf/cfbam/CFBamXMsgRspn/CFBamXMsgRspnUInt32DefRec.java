...
// Description: Java 11 XML Message SAX Response Record Element  for UInt32Def
...
/*
 *	CFBamXMsgRspnUInt32DefRec XML SAX Element  implementation
 *	for UInt32Def.
 */
public class CFBamXMsgRspnUInt32DefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32DefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt32DefObj obj = (ICFBamUInt32DefObj)(schemaObj.getUInt32DefTableObj().newInstance());
			CFBamUInt32DefBuff dataBuff = obj.getUInt32DefBuff();
