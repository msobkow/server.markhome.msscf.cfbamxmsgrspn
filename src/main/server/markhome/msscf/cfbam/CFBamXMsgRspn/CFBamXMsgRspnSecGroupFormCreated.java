...
/*
 *	CFBamXMsgRspnSecGroupFormCreated XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFBamXMsgRspnSecGroupFormCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGroupFormCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecGroupFormCreated" );
			...
			ICFBamSecGroupFormObj obj = (ICFBamSecGroupFormObj)schemaObj.getSecGroupFormTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFBamSecGroupFormObj realised = (ICFBamSecGroupFormObj)obj.realise();
