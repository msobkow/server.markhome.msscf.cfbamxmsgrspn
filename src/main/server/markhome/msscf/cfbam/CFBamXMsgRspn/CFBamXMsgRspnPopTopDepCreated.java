...
/*
 *	CFBamXMsgRspnPopTopDepCreated XML SAX Element  implementation
 *	for PopTopDep.
 */
public class CFBamXMsgRspnPopTopDepCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopTopDepCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopTopDepCreated" );
