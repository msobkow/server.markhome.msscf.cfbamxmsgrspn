...
/*
 *	CFBamXMsgRspnDelTopDepUpdated XML SAX Element  implementation
 *	for DelTopDep.
 */
public class CFBamXMsgRspnDelTopDepUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelTopDepUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelTopDepUpdated" );
