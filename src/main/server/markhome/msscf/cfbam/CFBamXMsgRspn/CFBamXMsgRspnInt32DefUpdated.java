...
/*
 *	CFBamXMsgRspnInt32DefUpdated XML SAX Element  implementation
 *	for Int32Def.
 */
public class CFBamXMsgRspnInt32DefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt32DefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt32DefUpdated" );
