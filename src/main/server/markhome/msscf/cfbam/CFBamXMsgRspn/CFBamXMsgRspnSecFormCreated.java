...
// Description: Java 11 XML Message SAX Response Record Element  for SecForm
...
/*
 *	CFBamXMsgRspnSecFormCreated XML SAX Element  implementation
 *	for SecForm.
 */
public class CFBamXMsgRspnSecFormCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecFormCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecFormCreated" );
			...
			ICFBamSecFormObj obj = (ICFBamSecFormObj)schemaObj.getSecFormTableObj().newInstance();
			CFSecSecFormBuff dataBuff = obj.getSecFormBuff();
			...
			obj.copyBuffToPKey();
			ICFBamSecFormObj realised = (ICFBamSecFormObj)obj.realise();
