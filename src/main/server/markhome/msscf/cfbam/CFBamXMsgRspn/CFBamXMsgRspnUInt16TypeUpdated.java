...
/*
 *	CFBamXMsgRspnUInt16TypeUpdated XML SAX Element  implementation
 *	for UInt16Type.
 */
public class CFBamXMsgRspnUInt16TypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16TypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt16TypeUpdated" );
