...
/*
 *	CFBamXMsgRspnDelSubDep2Created XML SAX Element  implementation
 *	for DelSubDep2.
 */
public class CFBamXMsgRspnDelSubDep2Created
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep2Created( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelSubDep2Created" );
