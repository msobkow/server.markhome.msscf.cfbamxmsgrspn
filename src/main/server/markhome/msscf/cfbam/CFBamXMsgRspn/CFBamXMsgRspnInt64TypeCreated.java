...
/*
 *	CFBamXMsgRspnInt64TypeCreated XML SAX Element  implementation
 *	for Int64Type.
 */
public class CFBamXMsgRspnInt64TypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt64TypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt64TypeCreated" );
