...
/*
 *	CFBamXMsgRspnDelSubDep1Created XML SAX Element  implementation
 *	for DelSubDep1.
 */
public class CFBamXMsgRspnDelSubDep1Created
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep1Created( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelSubDep1Created" );
