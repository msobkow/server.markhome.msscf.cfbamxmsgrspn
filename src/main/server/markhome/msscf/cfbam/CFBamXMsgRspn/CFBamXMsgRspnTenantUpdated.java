...
/*
 *	CFBamXMsgRspnTenantUpdated XML SAX Element  implementation
 *	for Tenant.
 */
public class CFBamXMsgRspnTenantUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTenantUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
