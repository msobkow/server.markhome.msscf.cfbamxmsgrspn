...
// Description: Java 11 XML Message SAX Response Record Element  for NumberDef
...
/*
 *	CFBamXMsgRspnNumberDefRec XML SAX Element  implementation
 *	for NumberDef.
 */
public class CFBamXMsgRspnNumberDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			if( ( attrDigits == null ) || ( attrDigits.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"Digits" );
			...
			short natDigits = Short.parseShort( attrDigits );
			...
			ICFBamNumberDefObj obj = (ICFBamNumberDefObj)(schemaObj.getNumberDefTableObj().newInstance());
			CFBamNumberDefBuff dataBuff = obj.getNumberDefBuff();
			...
			dataBuff.setRequiredDigits( natDigits );
