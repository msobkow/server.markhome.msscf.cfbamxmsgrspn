...
/*
 *	CFBamXMsgRspnTokenDefCreated XML SAX Element  implementation
 *	for TokenDef.
 */
public class CFBamXMsgRspnTokenDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTokenDefCreated" );
