...
// Description: Java 11 XML Message SAX Response Record Element  for StringDef
...
/*
 *	CFBamXMsgRspnStringDefRec XML SAX Element  implementation
 *	for StringDef.
 */
public class CFBamXMsgRspnStringDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				if( attrLocalName.equals( "Id" ) ) {
				...
				else if( attrLocalName.equals( "IsPolymorph" ) ) {
					...
					attrIsPolymorph = attrs.getValue( idxAttr );
				}
			...
			boolean natIsPolymorph;
			if( attrIsPolymorph.equals( "true" ) || attrIsPolymorph.equals( "yes" ) || attrIsPolymorph.equals( "1" ) ) {
				natIsPolymorph = true;
			}
			else if( attrIsPolymorph.equals( "false" ) || attrIsPolymorph.equals( "no" ) || attrIsPolymorph.equals( "0" ) ) {
				natIsPolymorph = false;
			}
			else {
				throw new CFLibUsageException( getClass(),
					S_ProcName,
					"Unexpected IsPolymorph value, must be one of true, false, yes, no, 1, or 0, not \"" + attrIsPolymorph + "\"" );
			}
			...
			ICFBamStringDefObj obj = (ICFBamStringDefObj)(schemaObj.getStringDefTableObj().newInstance());
			CFBamStringDefBuff dataBuff = obj.getStringDefBuff();
			...
			dataBuff.setRequiredIsPolymorph( natIsPolymorph );
