...
// Description: Java 11 XML Message SAX Response Record Element  for TZTimeType
...
/*
 *	CFBamXMsgRspnTZTimeTypeUpdated XML SAX Element  implementation
 *	for TZTimeType.
 */
public class CFBamXMsgRspnTZTimeTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimeTypeUpdated" );
			...
			CFBamTZTimeTypeBuff dataBuff = obj.getTZTimeTypeBuff();
