...
// Description: Java 11 XML Message SAX Response Record Element  for UInt64Col
...
/*
 *	CFBamXMsgRspnUInt64ColUpdated XML SAX Element  implementation
 *	for UInt64Col.
 */
public class CFBamXMsgRspnUInt64ColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64ColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt64ColUpdated" );
			...
			CFBamUInt64ColBuff dataBuff = obj.getUInt64ColBuff();
