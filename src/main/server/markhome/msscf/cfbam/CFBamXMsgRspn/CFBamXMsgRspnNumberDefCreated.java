...
/*
 *	CFBamXMsgRspnNumberDefCreated XML SAX Element  implementation
 *	for NumberDef.
 */
public class CFBamXMsgRspnNumberDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNumberDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNumberDefCreated" );
