...
/*
 *	CFBamXMsgRspnStringDefLocked XML SAX Element  implementation
 *	for StringDef.
 */
public class CFBamXMsgRspnStringDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnStringDefLocked" );
