...
/*
 *	CFBamXMsgRspnInt16ColCreated XML SAX Element  implementation
 *	for Int16Col.
 */
public class CFBamXMsgRspnInt16ColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16ColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt16ColCreated" );
