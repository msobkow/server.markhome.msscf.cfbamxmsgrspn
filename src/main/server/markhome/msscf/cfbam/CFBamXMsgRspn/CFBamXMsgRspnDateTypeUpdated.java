...
/*
 *	CFBamXMsgRspnDateTypeUpdated XML SAX Element  implementation
 *	for DateType.
 */
public class CFBamXMsgRspnDateTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDateTypeUpdated" );
