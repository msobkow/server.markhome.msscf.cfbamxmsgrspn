...
/*
 *	CFBamXMsgRspnTZTimestampTypeCreated XML SAX Element  implementation
 *	for TZTimestampType.
 */
public class CFBamXMsgRspnTZTimestampTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimestampTypeCreated" );
