...
/*
 *	CFBamXMsgRspnId64GenLocked XML SAX Element  implementation
 *	for Id64Gen.
 */
public class CFBamXMsgRspnId64GenLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnId64GenLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnId64GenLocked" );
