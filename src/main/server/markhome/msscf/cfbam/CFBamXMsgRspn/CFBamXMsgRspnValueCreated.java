...
// Description: Java 11 XML Message SAX Response Record Element  for Value
...
/*
 *	CFBamXMsgRspnValueCreated XML SAX Element  implementation
 *	for Value.
 */
public class CFBamXMsgRspnValueCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnValueCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnValueCreated" );
			...
			ICFBamValueObj obj = (ICFBamValueObj)schemaObj.getValueTableObj().newInstance();
