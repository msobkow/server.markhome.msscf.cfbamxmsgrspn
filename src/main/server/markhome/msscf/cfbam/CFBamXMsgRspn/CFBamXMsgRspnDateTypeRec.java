...
// Description: Java 11 XML Message SAX Response Record Element  for DateType
...
/*
 *	CFBamXMsgRspnDateTypeRec XML SAX Element  implementation
 *	for DateType.
 */
public class CFBamXMsgRspnDateTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamDateTypeBuff dataBuff = obj.getDateTypeBuff();
