...
/*
 *	CFBamXMsgRspnServerMethodUpdated XML SAX Element  implementation
 *	for ServerMethod.
 */
public class CFBamXMsgRspnServerMethodUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerMethodUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerMethodUpdated" );
