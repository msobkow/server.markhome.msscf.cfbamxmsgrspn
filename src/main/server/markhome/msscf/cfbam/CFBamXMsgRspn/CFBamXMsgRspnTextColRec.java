...
// Description: Java 11 XML Message SAX Response Record Element  for TextCol
...
/*
 *	CFBamXMsgRspnTextColRec XML SAX Element  implementation
 *	for TextCol.
 */
public class CFBamXMsgRspnTextColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamTextColBuff dataBuff = obj.getTextColBuff();
