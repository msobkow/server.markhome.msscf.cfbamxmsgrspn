...
/*
 *	CFBamXMsgRspnInt16TypeLocked XML SAX Element  implementation
 *	for Int16Type.
 */
public class CFBamXMsgRspnInt16TypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16TypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt16TypeLocked" );
