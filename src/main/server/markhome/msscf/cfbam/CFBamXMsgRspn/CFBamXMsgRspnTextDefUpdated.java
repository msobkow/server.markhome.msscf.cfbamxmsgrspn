...
/*
 *	CFBamXMsgRspnTextDefUpdated XML SAX Element  implementation
 *	for TextDef.
 */
public class CFBamXMsgRspnTextDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTextDefUpdated" );
