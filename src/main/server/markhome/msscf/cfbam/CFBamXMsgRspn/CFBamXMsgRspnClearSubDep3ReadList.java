...
/*
 *	CFBamXMsgRspnClearSubDep3ReadList XML SAX Element  implementation
 *	for ClearSubDep3.
 */
public class CFBamXMsgRspnClearSubDep3ReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep3ReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnClearSubDep3ReadList" );
