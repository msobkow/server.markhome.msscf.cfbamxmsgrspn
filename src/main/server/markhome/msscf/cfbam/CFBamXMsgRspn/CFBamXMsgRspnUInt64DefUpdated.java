...
/*
 *	CFBamXMsgRspnUInt64DefUpdated XML SAX Element  implementation
 *	for UInt64Def.
 */
public class CFBamXMsgRspnUInt64DefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64DefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt64DefUpdated" );
