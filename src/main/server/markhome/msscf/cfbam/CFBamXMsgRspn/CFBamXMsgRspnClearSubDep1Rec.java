...
// Description: Java 11 XML Message SAX Response Record Element  for ClearSubDep1
...
/*
 *	CFBamXMsgRspnClearSubDep1Rec XML SAX Element  implementation
 *	for ClearSubDep1.
 */
public class CFBamXMsgRspnClearSubDep1Rec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnClearSubDep1Rec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			String	attrClearTopDepTenantId = null;
			String	attrClearTopDepId = null;
			...
			assert qName.equals( "ClearSubDep1" );
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "ClearTopDepTenantId" ) ) {
					if( attrClearTopDepTenantId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrClearTopDepTenantId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "ClearTopDepId" ) ) {
					if( attrClearTopDepId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrClearTopDepId = attrs.getValue( idxAttr );
				}
			...
			if( ( attrClearTopDepTenantId == null ) || ( attrClearTopDepTenantId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"ClearTopDepTenantId" );
			}
			if( ( attrClearTopDepId == null ) || ( attrClearTopDepId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"ClearTopDepId" );
			...
			long natClearTopDepTenantId = Long.parseLong( attrClearTopDepTenantId );

			long natClearTopDepId = Long.parseLong( attrClearTopDepId );
			...
			CFBamClearSubDep1Buff dataBuff = obj.getClearSubDep1Buff();
			...
			dataBuff.setRequiredClearTopDepTenantId( natClearTopDepTenantId );
			dataBuff.setRequiredClearTopDepId( natClearTopDepId );
