...
/*
 *	CFBamXMsgRspnTSecGroupUpdated XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFBamXMsgRspnTSecGroupUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGroupUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGroupUpdated" );
			...
			ICFBamTSecGroupObj obj = (ICFBamTSecGroupObj)schemaObj.getTSecGroupTableObj().newInstance();
			CFSecTSecGroupBuff dataBuff = obj.getTSecGroupBuff();
			...
			obj.copyBuffToPKey();
			ICFBamTSecGroupObj realised = (ICFBamTSecGroupObj)obj.realise();
