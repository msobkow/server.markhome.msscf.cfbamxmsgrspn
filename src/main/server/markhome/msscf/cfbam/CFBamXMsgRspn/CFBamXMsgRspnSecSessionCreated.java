...
/*
 *	CFBamXMsgRspnSecSessionCreated XML SAX Element  implementation
 *	for SecSession.
 */
public class CFBamXMsgRspnSecSessionCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecSessionCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecSessionCreated" );
			...
			ICFBamSecSessionObj obj = (ICFBamSecSessionObj)schemaObj.getSecSessionTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFBamSecSessionObj realised = (ICFBamSecSessionObj)obj.realise();
