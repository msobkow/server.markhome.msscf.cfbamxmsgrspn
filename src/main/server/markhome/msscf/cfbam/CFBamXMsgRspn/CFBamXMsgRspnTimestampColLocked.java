...
/*
 *	CFBamXMsgRspnTimestampColLocked XML SAX Element  implementation
 *	for TimestampCol.
 */
public class CFBamXMsgRspnTimestampColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimestampColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTimestampColLocked" );
