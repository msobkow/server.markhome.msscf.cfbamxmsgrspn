...
/*
 *	CFBamXMsgRspnTenantLocked XML SAX Element  implementation
 *	for Tenant.
 */
public class CFBamXMsgRspnTenantLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTenantLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTenantLocked" );
