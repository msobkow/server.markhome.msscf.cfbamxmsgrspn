...
// Description: Java 11 XML Message SAX Response Record Element  for UInt64Type
...
/*
 *	CFBamXMsgRspnUInt64TypeCreated XML SAX Element  implementation
 *	for UInt64Type.
 */
public class CFBamXMsgRspnUInt64TypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64TypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt64TypeCreated" );
			...
			CFBamUInt64TypeBuff dataBuff = obj.getUInt64TypeBuff();
