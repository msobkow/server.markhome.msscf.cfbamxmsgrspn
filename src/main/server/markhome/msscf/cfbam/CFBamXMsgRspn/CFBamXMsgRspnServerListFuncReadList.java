...
/*
 *	CFBamXMsgRspnServerListFuncReadList XML SAX Element  implementation
 *	for ServerListFunc.
 */
public class CFBamXMsgRspnServerListFuncReadList
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerListFuncReadList( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerListFuncReadList" );
