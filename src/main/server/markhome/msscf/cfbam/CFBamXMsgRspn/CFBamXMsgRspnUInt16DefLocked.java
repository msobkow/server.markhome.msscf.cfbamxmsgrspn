...
/*
 *	CFBamXMsgRspnUInt16DefLocked XML SAX Element  implementation
 *	for UInt16Def.
 */
public class CFBamXMsgRspnUInt16DefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16DefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt16DefLocked" );
