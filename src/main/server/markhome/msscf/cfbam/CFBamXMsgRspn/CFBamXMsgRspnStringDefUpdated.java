...
/*
 *	CFBamXMsgRspnStringDefUpdated XML SAX Element  implementation
 *	for StringDef.
 */
public class CFBamXMsgRspnStringDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnStringDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnStringDefUpdated" );
