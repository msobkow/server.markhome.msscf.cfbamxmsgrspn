...
/*
 *	CFBamXMsgRspnDelSubDep1Locked XML SAX Element  implementation
 *	for DelSubDep1.
 */
public class CFBamXMsgRspnDelSubDep1Locked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep1Locked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelSubDep1Locked" );
