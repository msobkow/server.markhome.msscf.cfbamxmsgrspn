...
/*
 *	CFBamXMsgRspnUInt64ColLocked XML SAX Element  implementation
 *	for UInt64Col.
 */
public class CFBamXMsgRspnUInt64ColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64ColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt64ColLocked" );
