...
/*
 *	CFBamXMsgRspnSecGroupReadSingle XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFBamXMsgRspnSecGroupReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGroupReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecGroupReadSingle" );
