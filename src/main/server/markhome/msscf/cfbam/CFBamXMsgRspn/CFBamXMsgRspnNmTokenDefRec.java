...
// Description: Java 11 XML Message SAX Response Record Element  for NmTokenDef
...
/*
 *	CFBamXMsgRspnNmTokenDefRec XML SAX Element  implementation
 *	for NmTokenDef.
 */
public class CFBamXMsgRspnNmTokenDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "NmTokenDef" );
			...
			ICFBamNmTokenDefObj obj = (ICFBamNmTokenDefObj)(schemaObj.getNmTokenDefTableObj().newInstance());
			CFBamNmTokenDefBuff dataBuff = obj.getNmTokenDefBuff();
