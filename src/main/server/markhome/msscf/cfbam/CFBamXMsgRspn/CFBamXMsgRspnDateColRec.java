...
// Description: Java 11 XML Message SAX Response Record Element  for DateCol
...
/*
 *	CFBamXMsgRspnDateColRec XML SAX Element  implementation
 *	for DateCol.
 */
public class CFBamXMsgRspnDateColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamDateColBuff dataBuff = obj.getDateColBuff();
