...
/*
 *	CFBamXMsgRspnTableUpdated XML SAX Element  implementation
 *	for Table.
 */
public class CFBamXMsgRspnTableUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTableUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTableUpdated" );
