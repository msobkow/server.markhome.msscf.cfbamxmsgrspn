...
/*
 *	CFBamXMsgRspnId32GenLocked XML SAX Element  implementation
 *	for Id32Gen.
 */
public class CFBamXMsgRspnId32GenLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnId32GenLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnId32GenLocked" );
