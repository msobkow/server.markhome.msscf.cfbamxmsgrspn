...
/*
 *	CFBamXMsgRspnSecUserUpdated XML SAX Element  implementation
 *	for SecUser.
 */
public class CFBamXMsgRspnSecUserUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecUserUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSecUserUpdated" );
			...
			ICFBamSecUserObj obj = (ICFBamSecUserObj)schemaObj.getSecUserTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFBamSecUserObj realised = (ICFBamSecUserObj)obj.realise();
