...
/*
 *	CFBamXMsgRspnTextTypeUpdated XML SAX Element  implementation
 *	for TextType.
 */
public class CFBamXMsgRspnTextTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTextTypeUpdated" );
