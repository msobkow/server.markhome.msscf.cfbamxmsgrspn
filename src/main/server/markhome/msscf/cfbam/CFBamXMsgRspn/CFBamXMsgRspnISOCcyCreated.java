...
/*
 *	CFBamXMsgRspnISOCcyCreated XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFBamXMsgRspnISOCcyCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnISOCcyCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnISOCcyCreated" );
			...
			ICFBamISOCcyObj obj = (ICFBamISOCcyObj)schemaObj.getISOCcyTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFBamISOCcyObj realised = (ICFBamISOCcyObj)obj.realise();
