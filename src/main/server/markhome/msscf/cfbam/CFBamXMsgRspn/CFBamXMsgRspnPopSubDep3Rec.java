...
// Description: Java 11 XML Message SAX Response Record Element  for PopSubDep3
...
/*
 *	CFBamXMsgRspnPopSubDep3Rec XML SAX Element  implementation
 *	for PopSubDep3.
 */
public class CFBamXMsgRspnPopSubDep3Rec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep3Rec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			// PopSubDep3 Attributes
			String	attrPopSubDep2TenantId = null;
			String	attrPopSubDep2Id = null;
			...
			assert qName.equals( "PopSubDep3" );
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "PopSubDep2TenantId" ) ) {
					if( attrPopSubDep2TenantId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrPopSubDep2TenantId = attrs.getValue( idxAttr );
				}
				else if( attrLocalName.equals( "PopSubDep2Id" ) ) {
					if( attrPopSubDep2Id != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrPopSubDep2Id = attrs.getValue( idxAttr );
				}
			...
			if( ( attrPopSubDep2TenantId == null ) || ( attrPopSubDep2TenantId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"PopSubDep2TenantId" );
			}
			if( ( attrPopSubDep2Id == null ) || ( attrPopSubDep2Id.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"PopSubDep2Id" );
			...
			long natPopSubDep2TenantId = Long.parseLong( attrPopSubDep2TenantId );

			long natPopSubDep2Id = Long.parseLong( attrPopSubDep2Id );
			...
			CFBamPopSubDep3Buff dataBuff = obj.getPopSubDep3Buff();
			...
			dataBuff.setRequiredPopSubDep2TenantId( natPopSubDep2TenantId );
			dataBuff.setRequiredPopSubDep2Id( natPopSubDep2Id );
