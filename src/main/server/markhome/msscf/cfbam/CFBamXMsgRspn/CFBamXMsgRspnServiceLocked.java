...
/*
 *	CFBamXMsgRspnServiceLocked XML SAX Element  implementation
 *	for Service.
 */
public class CFBamXMsgRspnServiceLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServiceLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServiceLocked" );
