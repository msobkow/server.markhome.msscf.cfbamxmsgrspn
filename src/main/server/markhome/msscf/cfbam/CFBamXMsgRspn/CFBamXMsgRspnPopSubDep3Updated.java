...
/*
 *	CFBamXMsgRspnPopSubDep3Updated XML SAX Element  implementation
 *	for PopSubDep3.
 */
public class CFBamXMsgRspnPopSubDep3Updated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep3Updated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopSubDep3Updated" );
