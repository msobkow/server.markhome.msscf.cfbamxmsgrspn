...
/*
 *	CFBamXMsgRspnEnumDefUpdated XML SAX Element  implementation
 *	for EnumDef.
 */
public class CFBamXMsgRspnEnumDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnEnumDefUpdated" );
