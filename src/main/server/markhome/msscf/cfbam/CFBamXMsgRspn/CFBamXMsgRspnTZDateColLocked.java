...
/*
 *	CFBamXMsgRspnTZDateColLocked XML SAX Element  implementation
 *	for TZDateCol.
 */
public class CFBamXMsgRspnTZDateColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZDateColLocked" );
