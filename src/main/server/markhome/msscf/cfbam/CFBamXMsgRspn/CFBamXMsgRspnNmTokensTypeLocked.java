...
/*
 *	CFBamXMsgRspnNmTokensTypeLocked XML SAX Element  implementation
 *	for NmTokensType.
 */
public class CFBamXMsgRspnNmTokensTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokensTypeLocked" );
