...
/*
 *	CFBamXMsgRspnTZTimestampDefCreated XML SAX Element  implementation
 *	for TZTimestampDef.
 */
public class CFBamXMsgRspnTZTimestampDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimestampDefCreated" );
