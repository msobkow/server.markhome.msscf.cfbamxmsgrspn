...
/*
 *	CFBamXMsgRspnDelSubDep2Locked XML SAX Element  implementation
 *	for DelSubDep2.
 */
public class CFBamXMsgRspnDelSubDep2Locked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDelSubDep2Locked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDelSubDep2Locked" );
