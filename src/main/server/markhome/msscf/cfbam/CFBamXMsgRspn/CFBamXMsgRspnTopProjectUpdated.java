...
// Description: Java 11 XML Message SAX Response Record Element  for TopProject
...
/*
 *	CFBamXMsgRspnTopProjectUpdated XML SAX Element  implementation
 *	for TopProject.
 */
public class CFBamXMsgRspnTopProjectUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTopProjectUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTopProjectUpdated" );
			...
			CFIntTopProjectBuff dataBuff = obj.getTopProjectBuff();
			...
			obj.copyBuffToPKey();
			ICFBamTopProjectObj realised = (ICFBamTopProjectObj)obj.realise();
