...
/*
 *	CFBamXMsgRspnPopSubDep2Created XML SAX Element  implementation
 *	for PopSubDep2.
 */
public class CFBamXMsgRspnPopSubDep2Created
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopSubDep2Created( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopSubDep2Created" );
