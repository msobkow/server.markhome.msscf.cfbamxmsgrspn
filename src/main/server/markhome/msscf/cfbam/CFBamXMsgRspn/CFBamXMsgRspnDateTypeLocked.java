...
/*
 *	CFBamXMsgRspnDateTypeLocked XML SAX Element  implementation
 *	for DateType.
 */
public class CFBamXMsgRspnDateTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateTypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDateTypeLocked" );
