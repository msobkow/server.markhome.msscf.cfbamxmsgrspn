...
/*
 *	CFBamXMsgRspnTableReadSingle XML SAX Element  implementation
 *	for Table.
 */
public class CFBamXMsgRspnTableReadSingle
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTableReadSingle( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTableReadSingle" );
