...
// Description: Java 11 XML Message SAX Response Record Element  for TSecGrpInc
...
/*
 *	CFBamXMsgRspnTSecGrpIncUpdated XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFBamXMsgRspnTSecGrpIncUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTSecGrpIncUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTSecGrpIncUpdated" );
			...
			for( idxAttr = 0; idxAttr < numAttrs; idxAttr++ ) {
				...
				else if( attrLocalName.equals( "TSecGrpIncId" ) ) {
					if( attrTSecGrpIncId != null ) {
						throw new CFLibUniqueIndexViolationException( getClass(),
							S_ProcName,
							S_LocalName,
							attrLocalName );
					}
					attrTSecGrpIncId = attrs.getValue( idxAttr );
				}
			...
			if( ( attrTSecGrpIncId == null ) || ( attrTSecGrpIncId.length() <= 0 ) ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"TSecGrpIncId" );
			...
			long natTSecGrpIncId = Long.parseLong( attrTSecGrpIncId );
			...
			ICFBamTSecGrpIncObj obj = (ICFBamTSecGrpIncObj)schemaObj.getTSecGrpIncTableObj().newInstance();
			CFSecTSecGrpIncBuff dataBuff = obj.getTSecGrpIncBuff();
			dataBuff.setRequiredTenantId( natTenantId );
			dataBuff.setRequiredTSecGrpIncId( natTSecGrpIncId );
			...
			obj.copyBuffToPKey();
			ICFBamTSecGrpIncObj realised = (ICFBamTSecGrpIncObj)obj.realise();
