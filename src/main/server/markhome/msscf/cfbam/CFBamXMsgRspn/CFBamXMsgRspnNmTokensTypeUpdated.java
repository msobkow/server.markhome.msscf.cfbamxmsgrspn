...
/*
 *	CFBamXMsgRspnNmTokensTypeUpdated XML SAX Element  implementation
 *	for NmTokensType.
 */
public class CFBamXMsgRspnNmTokensTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokensTypeUpdated" );
