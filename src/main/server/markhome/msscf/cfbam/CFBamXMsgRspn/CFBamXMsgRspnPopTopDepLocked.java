...
/*
 *	CFBamXMsgRspnPopTopDepLocked XML SAX Element  implementation
 *	for PopTopDep.
 */
public class CFBamXMsgRspnPopTopDepLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopTopDepLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopTopDepLocked" );
