...
/*
 *	CFBamXMsgRspnNmTokensColUpdated XML SAX Element  implementation
 *	for NmTokensCol.
 */
public class CFBamXMsgRspnNmTokensColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokensColUpdated" );
