...
// Description: Java 11 XML Message SAX Response Record Element  for TZDateDef
...
/*
 *	CFBamXMsgRspnTZDateDefRec XML SAX Element  implementation
 *	for TZDateDef.
 */
public class CFBamXMsgRspnTZDateDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZDateDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZDateDefObj obj = (ICFBamTZDateDefObj)(schemaObj.getTZDateDefTableObj().newInstance());
			CFBamTZDateDefBuff dataBuff = obj.getTZDateDefBuff();
