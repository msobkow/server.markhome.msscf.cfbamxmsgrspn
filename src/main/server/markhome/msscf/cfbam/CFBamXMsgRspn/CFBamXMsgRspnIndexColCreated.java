...
/*
 *	CFBamXMsgRspnIndexColCreated XML SAX Element  implementation
 *	for IndexCol.
 */
public class CFBamXMsgRspnIndexColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnIndexColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnIndexColCreated" );
