...
// Description: Java 11 XML Message SAX Response Record Element  for TokenType
...
/*
 *	CFBamXMsgRspnTokenTypeUpdated XML SAX Element  implementation
 *	for TokenType.
 */
public class CFBamXMsgRspnTokenTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTokenTypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTokenTypeUpdated" );
			...
			CFBamTokenTypeBuff dataBuff = obj.getTokenTypeBuff();
