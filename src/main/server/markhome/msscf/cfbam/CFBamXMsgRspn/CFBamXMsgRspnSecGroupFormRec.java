...
/*
 *	CFBamXMsgRspnSecGroupFormRec XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFBamXMsgRspnSecGroupFormRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSecGroupFormRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFSecSecGroupFormObj> list =
				(List<ICFSecSecGroupFormObj>)xmsgRspn.getListOfObjects();
