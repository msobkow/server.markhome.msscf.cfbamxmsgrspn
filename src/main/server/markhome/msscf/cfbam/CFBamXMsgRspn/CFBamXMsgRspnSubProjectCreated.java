...
/*
 *	CFBamXMsgRspnSubProjectCreated XML SAX Element  implementation
 *	for SubProject.
 */
public class CFBamXMsgRspnSubProjectCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnSubProjectCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnSubProjectCreated" );
			...
			CFIntSubProjectBuff dataBuff = obj.getSubProjectBuff();
			...
			obj.copyBuffToPKey();
			ICFBamSubProjectObj realised = (ICFBamSubProjectObj)obj.realise();
