...
/*
 *	CFBamXMsgRspnTextColUpdated XML SAX Element  implementation
 *	for TextCol.
 */
public class CFBamXMsgRspnTextColUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTextColUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTextColUpdated" );
