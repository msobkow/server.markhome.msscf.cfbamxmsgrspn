...
/*
 *	CFBamXMsgRspnUuidColCreated XML SAX Element  implementation
 *	for UuidCol.
 */
public class CFBamXMsgRspnUuidColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUuidColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUuidColCreated" );
