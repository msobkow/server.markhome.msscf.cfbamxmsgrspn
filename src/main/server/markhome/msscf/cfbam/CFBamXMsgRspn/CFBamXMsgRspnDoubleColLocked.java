...
/*
 *	CFBamXMsgRspnDoubleColLocked XML SAX Element  implementation
 *	for DoubleCol.
 */
public class CFBamXMsgRspnDoubleColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDoubleColLocked" );
