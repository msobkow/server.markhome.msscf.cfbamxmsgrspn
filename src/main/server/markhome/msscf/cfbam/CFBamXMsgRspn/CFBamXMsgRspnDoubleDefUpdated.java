...
/*
 *	CFBamXMsgRspnDoubleDefUpdated XML SAX Element  implementation
 *	for DoubleDef.
 */
public class CFBamXMsgRspnDoubleDefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDoubleDefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDoubleDefUpdated" );
