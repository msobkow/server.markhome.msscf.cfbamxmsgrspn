...
/*
 *	CFBamXMsgRspnServerListFuncCreated XML SAX Element  implementation
 *	for ServerListFunc.
 */
public class CFBamXMsgRspnServerListFuncCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerListFuncCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerListFuncCreated" );
