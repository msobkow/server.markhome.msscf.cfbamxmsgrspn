...
/*
 *	CFBamXMsgRspnNmTokenColRec XML SAX Element  implementation
 *	for NmTokenCol.
 */
public class CFBamXMsgRspnNmTokenColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokenColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
