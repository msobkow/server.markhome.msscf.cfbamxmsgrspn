...
/*
 *	CFBamXMsgRspnScopeCreated XML SAX Element  implementation
 *	for Scope.
 */
public class CFBamXMsgRspnScopeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnScopeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnScopeCreated" );
