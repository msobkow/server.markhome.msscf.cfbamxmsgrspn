...
/*
 *	CFBamXMsgRspnUInt64TypeUpdated XML SAX Element  implementation
 *	for UInt64Type.
 */
public class CFBamXMsgRspnUInt64TypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64TypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt64TypeUpdated" );
