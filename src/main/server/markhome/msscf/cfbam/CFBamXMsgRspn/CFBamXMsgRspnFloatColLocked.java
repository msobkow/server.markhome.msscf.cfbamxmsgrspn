...
/*
 *	CFBamXMsgRspnFloatColLocked XML SAX Element  implementation
 *	for FloatCol.
 */
public class CFBamXMsgRspnFloatColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFloatColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnFloatColLocked" );
