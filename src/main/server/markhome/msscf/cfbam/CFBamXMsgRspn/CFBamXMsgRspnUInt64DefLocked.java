...
/*
 *	CFBamXMsgRspnUInt64DefLocked XML SAX Element  implementation
 *	for UInt64Def.
 */
public class CFBamXMsgRspnUInt64DefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt64DefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt64DefLocked" );
