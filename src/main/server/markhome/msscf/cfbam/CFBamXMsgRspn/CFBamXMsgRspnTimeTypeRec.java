...
// Description: Java 11 XML Message SAX Response Record Element  for TimeType
...
/*
 *	CFBamXMsgRspnTimeTypeRec XML SAX Element  implementation
 *	for TimeType.
 */
public class CFBamXMsgRspnTimeTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTimeTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamTimeTypeBuff dataBuff = obj.getTimeTypeBuff();
