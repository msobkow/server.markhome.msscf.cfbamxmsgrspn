...
/*
 *	CFBamXMsgRspnPopDepCreated XML SAX Element  implementation
 *	for PopDep.
 */
public class CFBamXMsgRspnPopDepCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnPopDepCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnPopDepCreated" );
