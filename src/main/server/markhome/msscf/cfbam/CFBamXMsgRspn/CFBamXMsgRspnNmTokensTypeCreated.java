...
/*
 *	CFBamXMsgRspnNmTokensTypeCreated XML SAX Element  implementation
 *	for NmTokensType.
 */
public class CFBamXMsgRspnNmTokensTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnNmTokensTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnNmTokensTypeCreated" );
