...
// Description: Java 11 XML Message SAX Response Record Element  for EnumDef
...
/*
 *	CFBamXMsgRspnEnumDefRec XML SAX Element  implementation
 *	for EnumDef.
 */
public class CFBamXMsgRspnEnumDefRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumDefRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamEnumDefObj obj = (ICFBamEnumDefObj)(schemaObj.getEnumDefTableObj().newInstance());
			CFBamEnumDefBuff dataBuff = obj.getEnumDefBuff();
