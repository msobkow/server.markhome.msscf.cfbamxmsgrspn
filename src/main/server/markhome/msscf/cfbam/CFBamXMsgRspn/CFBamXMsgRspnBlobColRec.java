...
// Description: Java 11 XML Message SAX Response Record Element  for BlobCol
...
/*
 *	CFBamXMsgRspnBlobColRec XML SAX Element  implementation
 *	for BlobCol.
 */
public class CFBamXMsgRspnBlobColRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBlobColRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			CFBamBlobColBuff dataBuff = obj.getBlobColBuff();
