...
/*
 *	CFBamXMsgRspnEnumDefLocked XML SAX Element  implementation
 *	for EnumDef.
 */
public class CFBamXMsgRspnEnumDefLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnEnumDefLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnEnumDefLocked" );
