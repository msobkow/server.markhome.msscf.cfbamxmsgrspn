...
/*
 *	CFBamXMsgRspnFileLoaded XML SAX Element  implementation
 */
public class CFBamXMsgRspnFileLoaded
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnFileLoaded( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			xmsgRspn.setLogContent( attrLogContent );
		}
