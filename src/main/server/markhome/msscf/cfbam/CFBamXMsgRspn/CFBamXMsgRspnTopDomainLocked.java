...
/*
 *	CFBamXMsgRspnTopDomainLocked XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFBamXMsgRspnTopDomainLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTopDomainLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
