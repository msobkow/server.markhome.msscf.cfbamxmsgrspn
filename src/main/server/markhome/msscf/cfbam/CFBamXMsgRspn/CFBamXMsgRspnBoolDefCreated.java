...
// Description: Java 11 XML Message SAX Response Record Element  for BoolDef
...
/*
 *	CFBamXMsgRspnBoolDefCreated XML SAX Element  implementation
 *	for BoolDef.
 */
public class CFBamXMsgRspnBoolDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnBoolDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnBoolDefCreated" );
			...
			ICFBamBoolDefObj obj = (ICFBamBoolDefObj)schemaObj.getBoolDefTableObj().newInstance();
			CFBamBoolDefBuff dataBuff = obj.getBoolDefBuff();
			...
			dataBuff.setOptionalFalseString( natFalseString );
			dataBuff.setOptionalTrueString( natTrueString );
			dataBuff.setOptionalNullString( natNullString );
			obj.copyBuffToPKey();
