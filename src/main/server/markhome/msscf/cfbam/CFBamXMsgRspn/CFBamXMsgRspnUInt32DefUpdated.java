...
/*
 *	CFBamXMsgRspnUInt32DefUpdated XML SAX Element  implementation
 *	for UInt32Def.
 */
public class CFBamXMsgRspnUInt32DefUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32DefUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt32DefUpdated" );
