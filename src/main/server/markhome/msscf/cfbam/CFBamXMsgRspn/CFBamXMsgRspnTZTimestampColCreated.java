...
/*
 *	CFBamXMsgRspnTZTimestampColCreated XML SAX Element  implementation
 *	for TZTimestampCol.
 */
public class CFBamXMsgRspnTZTimestampColCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampColCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimestampColCreated" );
