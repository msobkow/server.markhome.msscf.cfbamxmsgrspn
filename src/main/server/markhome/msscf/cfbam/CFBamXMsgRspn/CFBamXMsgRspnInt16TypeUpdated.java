...
/*
 *	CFBamXMsgRspnInt16TypeUpdated XML SAX Element  implementation
 *	for Int16Type.
 */
public class CFBamXMsgRspnInt16TypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnInt16TypeUpdated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnInt16TypeUpdated" );
