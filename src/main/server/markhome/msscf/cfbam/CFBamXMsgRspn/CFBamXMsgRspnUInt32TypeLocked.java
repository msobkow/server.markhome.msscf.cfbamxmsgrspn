...
/*
 *	CFBamXMsgRspnUInt32TypeLocked XML SAX Element  implementation
 *	for UInt32Type.
 */
public class CFBamXMsgRspnUInt32TypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt32TypeLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt32TypeLocked" );
