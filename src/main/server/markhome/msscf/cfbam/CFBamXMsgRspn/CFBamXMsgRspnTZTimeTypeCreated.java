...
/*
 *	CFBamXMsgRspnTZTimeTypeCreated XML SAX Element  implementation
 *	for TZTimeType.
 */
public class CFBamXMsgRspnTZTimeTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimeTypeCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTZTimeTypeCreated" );
