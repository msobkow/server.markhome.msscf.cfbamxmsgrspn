...
// Description: Java 11 XML Message SAX Response Record Element  for TZTimestampType
...
/*
 *	CFBamXMsgRspnTZTimestampTypeRec XML SAX Element  implementation
 *	for TZTimestampType.
 */
public class CFBamXMsgRspnTZTimestampTypeRec
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTZTimestampTypeRec( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "TZTimestampType" );
			...
			CFBamTZTimestampTypeBuff dataBuff = obj.getTZTimestampTypeBuff();
