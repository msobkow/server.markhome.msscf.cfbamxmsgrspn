...
/*
 *	CFBamXMsgRspnServerProcLocked XML SAX Element  implementation
 *	for ServerProc.
 */
public class CFBamXMsgRspnServerProcLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnServerProcLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnServerProcLocked" );
