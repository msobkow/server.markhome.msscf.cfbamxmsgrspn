...
/*
 *	CFBamXMsgRspnDateDefCreated XML SAX Element  implementation
 *	for DateDef.
 */
public class CFBamXMsgRspnDateDefCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnDateDefCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnDateDefCreated" );
