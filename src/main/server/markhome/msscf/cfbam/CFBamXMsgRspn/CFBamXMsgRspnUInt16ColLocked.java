...
/*
 *	CFBamXMsgRspnUInt16ColLocked XML SAX Element  implementation
 *	for UInt16Col.
 */
public class CFBamXMsgRspnUInt16ColLocked
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnUInt16ColLocked( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnUInt16ColLocked" );
