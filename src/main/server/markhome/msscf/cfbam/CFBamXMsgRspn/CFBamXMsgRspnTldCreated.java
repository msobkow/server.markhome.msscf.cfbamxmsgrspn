...
/*
 *	CFBamXMsgRspnTldCreated XML SAX Element  implementation
 *	for Tld.
 */
public class CFBamXMsgRspnTldCreated
	extends CFLibXmlCoreElementHandler
{
	public CFBamXMsgRspnTldCreated( CFBamXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			assert qName.equals( "RspnTldCreated" );
